...
/*!
  \file terralib/sqlite/DataSetTypePersistence.h

  \brief DataSetTypePersistence implementation for SQLite.
*/

#ifndef __TERRALIB_SQLITE_INTERNAL_DATASETTYPEPERSISTENCE_H
#define __TERRALIB_SQLITE_INTERNAL_DATASETTYPEPERSISTENCE_H
...
// Forward declaration
    ...
    */
    class TESQLITEEXPORT DataSetTypePersistence : public te::da::DataSetTypePersistence
    {
      public:
...
#endif  // __TERRALIB_SQLITE_INTERNAL_DATASETTYPEPERSISTENCE_H
