...
#ifndef __TE_QT_PLUGINS_TERRAMOBILE_INTERNAL_BUILDERINPUTLAYERSWIZARDPAGE_H
#define __TE_QT_PLUGINS_TERRAMOBILE_INTERNAL_BUILDERINPUTLAYERSWIZARDPAGE_H
    ...
    namespace plugins
    {
      namespace terramobile
      {
        /*!
          ...
          \brief This interface is used to get the input layers parameters for GeoPackage Builder wizard operation.
        */
        class BuilderInputLayersWizardPage : public QWizardPage
        {
          Q_OBJECT
...
#endif  // __TE_QT_PLUGINS_TERRAMOBILE_INTERNAL_BUILDERINPUTLAYERSWIZARDPAGE_H
