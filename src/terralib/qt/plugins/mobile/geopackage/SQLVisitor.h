...
#ifndef __TERRALIB_GPKG_INTERNAL_SQLVISITOR_H
#define __TERRALIB_GPKG_INTERNAL_SQLVISITOR_H
...
namespace te
{
  ...
  namespace gpkg
  {
    class TERRAMOBILEPLUGINSDLLEXPORT SQLVisitor : public te::da::SQLVisitor
    {
      public:
...
#endif //__TERRALIB_GPKG_INTERNAL_SQLVISITOR_H
