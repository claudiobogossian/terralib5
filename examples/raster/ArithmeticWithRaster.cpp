...
// set raster names
    ...
    sri["URI"] = TERRALIB_DATA_DIR "/geotiff/cbers2b_rgb342_crop.tif";
    srndvi["URI"] = TERRALIB_DATA_DIR "/geotiff/cbers2b_ndvi.tif";
    srndvin["URI"] = TERRALIB_DATA_DIR "/geotiff/cbers2b_ndvi_normalized.tif";
    std::string base_path = TERRALIB_DATA_DIR "/geotiff/";
