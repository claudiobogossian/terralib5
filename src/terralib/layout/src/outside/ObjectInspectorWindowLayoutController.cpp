...
te::layout::ObjectInspectorWindowLayoutController::ObjectInspectorWindowLayoutController( LayoutObservable* o ) :
	LayoutOutsideController(o)
{
  ...
  if(factory)
	  m_view = (LayoutObserver*)factory->make(TPObjectInspectorWindow, params);
}
