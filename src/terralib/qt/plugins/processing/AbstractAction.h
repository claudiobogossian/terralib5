...
/*!
  \file terralib/qt/plugins/processing/AbstractAction.h

  \brief This file defines the abstract class AbstractAction
*/

#ifndef __TE_QT_PLUGINS_PROCESSING_INTERNAL_ABSTRACTACTION_H
#define __TE_QT_PLUGINS_PROCESSING_INTERNAL_ABSTRACTACTION_H
    ...
    namespace plugins
    {
      namespace processing
      {
        /*!
          ...
          \brief This is an abstract class used to register actions into Processing pluging.
...
#endif //__TE_QT_PLUGINS_PROCESSING_INTERNAL_ABSTRACTACTION_H