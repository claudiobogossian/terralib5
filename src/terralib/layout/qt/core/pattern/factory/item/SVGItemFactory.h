...
/*!
  \file terralib/layout/qt/core/pattern/factory/SVGItemFactory.h

  \brief This is the concrete factory for SVG item.
 */

#ifndef __TERRALIB_LAYOUT_INTERNAL_SVG_ITEM_FACTORY_H
#define __TERRALIB_LAYOUT_INTERNAL_SVG_ITEM_FACTORY_H
...
namespace te
{
  namespace layout
  {
    ...
    */
    class TELAYOUTEXPORT SVGItemFactory : public NewItemFactory
    {
      public:
