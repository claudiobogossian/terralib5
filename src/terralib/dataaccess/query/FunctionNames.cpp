...
const std::string te::da::FunctionNames::sm_ST_Boundary("st_boundary");
const std::string te::da::FunctionNames::sm_ST_Centroid("st_centroid");
const std::string te::da::FunctionNames::sm_ST_Collect("st_collect");
...
const std::string te::da::FunctionNames::sm_ST_Dump("st_dump");
const std::string te::da::FunctionNames::sm_ST_DumpRings("st_dumprings");
const std::string te::da::FunctionNames::sm_ST_DWithin("st_dwithin");
const std::string te::da::FunctionNames::sm_ST_Envelope("st_envelope");
