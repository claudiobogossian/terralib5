...
{
  throw te::common::Exception(TE_TR("The method begin() is not supported by the WMS driver!"));
}

void te::ws::ogc::wms::da::Transactor::commit()
{
  throw te::common::Exception(TE_TR("The method commit() is not supported by the WMS driver!"));
}

void te::ws::ogc::wms::da::Transactor::rollBack()
{
  throw te::common::Exception(TE_TR("The method rollBack() is not supported by the WMS driver!"));
}
...
{
  throw te::common::Exception(TE_TR("The ObjectIdSet concept is not supported by the WMS driver!"));
}
...
std::auto_ptr<te::da::DataSet> te::ws::ogc::wms::da::Transactor::query(const te::da::Select &q,
                                                                       ...
                                                                       const te::common::AccessPolicy accessPolicy)
{
  throw te::common::Exception(TE_TR("Query operations is not supported by the WMS driver!"));
}
...
te::ws::ogc::wms::Layer te::ws::ogc::wms::da::Transactor::getLayerByName(const std::string &layerName)
{
  if(!this->dataSetExists(layerName))
    throw te::common::Exception(TE_TR("The informed data set could not be found in the data source."));
...
std::auto_ptr<te::dt::Property> te::ws::ogc::wms::da::Transactor::getProperty(const std::string &datasetName, const std::string &name)
{
  ...
  throw te::common::Exception(TE_TR("The informed property name could not be found in the data set."));
}
...
std::auto_ptr<te::dt::Property> te::ws::ogc::wms::da::Transactor::getProperty(const std::string &datasetName, std::size_t propertyPos)
{
  ...
  if(propertyPos >= props.size())
    throw te::common::Exception(TE_TR("The informed property position could not be found in the data set."));
...
{
  throw te::common::Exception(TE_TR("The method execute() is not supported by the WMS driver!"));
}
...
{
  throw te::common::Exception(TE_TR("The method isInTransaction() is not supported by the WMS driver!"));
}

std::auto_ptr<te::da::PreparedQuery> te::ws::ogc::wms::da::Transactor::getPrepared(const std::string& /*qName*/)
{
  throw te::common::Exception(TE_TR("The method getPrepared() is not supported by the WMS driver!"));
}

std::auto_ptr<te::da::BatchExecutor> te::ws::ogc::wms::da::Transactor::getBatchExecutor()
{
  throw te::common::Exception(TE_TR("The method getBatchExecutor() is not supported by the WMS driver!"));
}

void te::ws::ogc::wms::da::Transactor::cancel()
{
  throw te::common::Exception(TE_TR("The method cancel() is not supported by the WMS driver!"));
}

boost::int64_t te::ws::ogc::wms::da::Transactor::getLastGeneratedId()
{
  throw te::common::Exception(TE_TR("The method getLastGeneratedId() is not supported by the WMS driver!"));
}

std::string te::ws::ogc::wms::da::Transactor::escape(const std::string& /*value*/)
{
  throw te::common::Exception(TE_TR("The method escape() is not supported by the WMS driver!"));
}

bool te::ws::ogc::wms::da::Transactor::isDataSetNameValid(const std::string& /*datasetName*/)
{
  throw te::common::Exception(TE_TR("The method isDataSetNameValid() is not supported by the WMS driver!"));
}

bool te::ws::ogc::wms::da::Transactor::isPropertyNameValid(const std::string& /*propertyName*/)
{
  throw te::common::Exception(TE_TR("The method isPropertyNameValid() is not supported by the WMS driver!"));
}

void te::ws::ogc::wms::da::Transactor::addProperty(const std::string& /*datasetName*/, te::dt::Property* /*p*/)
{
 throw te::common::Exception(TE_TR("The method addProperty() is not supported by the WMS driver!"));
}

void te::ws::ogc::wms::da::Transactor::dropProperty(const std::string& /*datasetName*/, const std::string& /*name*/)
{
  throw te::common::Exception(TE_TR("The method dropProperty() is not supported by the WMS driver!"));
}
...
{
  throw te::common::Exception(TE_TR("The method renameProperty() is not supported by the WMS driver!"));
}

std::auto_ptr<te::da::PrimaryKey> te::ws::ogc::wms::da::Transactor::getPrimaryKey(const std::string& /*datasetName*/)
{
  throw te::common::Exception(TE_TR("The method getPrimaryKey() is not supported by the WMS driver!"));
}

bool te::ws::ogc::wms::da::Transactor::primaryKeyExists(const std::string& /*datasetName*/, const std::string& /*name*/)
{
  throw te::common::Exception(TE_TR("The method primaryKeyExists() is not supported by the WMS driver!"));
}

void te::ws::ogc::wms::da::Transactor::addPrimaryKey(const std::string& /*datasetName*/, te::da::PrimaryKey* /*pk*/)
{
  throw te::common::Exception(TE_TR("The method addPrimaryKey() is not supported by the WMS driver!"));
}

void te::ws::ogc::wms::da::Transactor::dropPrimaryKey(const std::string& /*datasetName*/)
{
  throw te::common::Exception(TE_TR("The method dropPrimaryKey() is not supported by the WMS driver!"));
}
...
{
  throw te::common::Exception(TE_TR("The method getForeignKey() is not supported by the WMS driver!"));
}

std::vector<std::string> te::ws::ogc::wms::da::Transactor::getForeignKeyNames(const std::string& /*datasetName*/)
{
  throw te::common::Exception(TE_TR("The method getForeignKeyNames() is not supported by the WMS driver!"));
}

bool te::ws::ogc::wms::da::Transactor::foreignKeyExists(const std::string& /*datasetName*/, const std::string& /*name*/)
{
  throw te::common::Exception(TE_TR("The method foreignKeyExists() is not supported by the WMS driver!"));
}

void te::ws::ogc::wms::da::Transactor::addForeignKey(const std::string& /*datasetName*/, te::da::ForeignKey* /*fk*/)
{
  throw te::common::Exception(TE_TR("The method addForeignKey() is not supported by the WMS driver!"));
}

void te::ws::ogc::wms::da::Transactor::dropForeignKey(const std::string& /*datasetName*/, const std::string& /*fkName*/)
{
  throw te::common::Exception(TE_TR("The method dropForeignKey() is not supported by the WMS driver!"));
}

std::auto_ptr<te::da::UniqueKey> te::ws::ogc::wms::da::Transactor::getUniqueKey(const std::string& /*datasetName*/, const std::string& /*name*/)
{
  throw te::common::Exception(TE_TR("The method getUniqueKey() is not supported by the WMS driver!"));
}

std::vector<std::string> te::ws::ogc::wms::da::Transactor::getUniqueKeyNames(const std::string& /*datasetName*/)
{
  throw te::common::Exception(TE_TR("The method getUniqueKeyNames() is not supported by the WMS driver!"));
}

bool te::ws::ogc::wms::da::Transactor::uniqueKeyExists(const std::string& /*datasetName*/, const std::string& /*name*/)
{
  throw te::common::Exception(TE_TR("The method uniqueKeyExists() is not supported by the WMS driver!"));
}

void te::ws::ogc::wms::da::Transactor::addUniqueKey(const std::string& /*datasetName*/, te::da::UniqueKey* /*uk*/)
{
  throw te::common::Exception(TE_TR("The method addUniqueKey() is not supported by the WMS driver!"));
}

void te::ws::ogc::wms::da::Transactor::dropUniqueKey(const std::string& /*datasetName*/, const std::string& /*name*/)
{
  throw te::common::Exception(TE_TR("The method dropUniqueKey() is not supported by the WMS driver!"));
}
...
{
  throw te::common::Exception(TE_TR("The method getCheckConstraint() is not supported by the WMS driver!"));
}

std::vector<std::string> te::ws::ogc::wms::da::Transactor::getCheckConstraintNames(const std::string& /*datasetName*/)
{
  throw te::common::Exception(TE_TR("The method getCheckConstraintNames() is not supported by the WMS driver!"));
}

bool te::ws::ogc::wms::da::Transactor::checkConstraintExists(const std::string& /*datasetName*/, const std::string& /*name*/)
{
  throw te::common::Exception(TE_TR("The method checkConstraintExists() is not supported by the WMS driver!"));
}

void te::ws::ogc::wms::da::Transactor::addCheckConstraint(const std::string& /*datasetName*/, te::da::CheckConstraint* /*cc*/)
{
  throw te::common::Exception(TE_TR("The method addCheckConstraint() is not supported by the WMS driver!"));
}

void te::ws::ogc::wms::da::Transactor::dropCheckConstraint(const std::string& /*datasetName*/, const std::string& /*name*/)
{
  throw te::common::Exception(TE_TR("The method dropCheckConstraint() is not supported by the WMS driver!"));
}

std::auto_ptr<te::da::Index> te::ws::ogc::wms::da::Transactor::getIndex(const std::string& /*datasetName*/, const std::string& /*name*/)
{
  throw te::common::Exception(TE_TR("The method getIndex() is not supported by the WMS driver!"));
}

std::vector<std::string> te::ws::ogc::wms::da::Transactor::getIndexNames(const std::string& /*datasetName*/)
{
  throw te::common::Exception(TE_TR("The method getIndexNames() is not supported by the WMS driver!"));
}

bool te::ws::ogc::wms::da::Transactor::indexExists(const std::string& /*datasetName*/, const std::string& /*name*/)
{
  throw te::common::Exception(TE_TR("The method indexExists() is not supported by the WMS driver!"));
}
...
{
  throw te::common::Exception(TE_TR("The method addIndex() is not supported by the WMS driver!"));
}

void te::ws::ogc::wms::da::Transactor::dropIndex(const std::string& /*datasetName*/, const std::string& /*idxName*/)
{
  throw te::common::Exception(TE_TR("The method dropIndex() is not supported by the WMS driver!"));
}

std::auto_ptr<te::da::Sequence> te::ws::ogc::wms::da::Transactor::getSequence(const std::string& /*name*/)
{
  throw te::common::Exception(TE_TR("The method getSequence() is not supported by the WMS driver!"));
}

std::vector<std::string> te::ws::ogc::wms::da::Transactor::getSequenceNames()
{
  throw te::common::Exception(TE_TR("The method getSequenceNames() is not supported by the WMS driver!"));
}

bool te::ws::ogc::wms::da::Transactor::sequenceExists(const std::string& /*name*/)
{
  throw te::common::Exception(TE_TR("The method sequenceExists() is not supported by the WMS driver!"));
}

void te::ws::ogc::wms::da::Transactor::addSequence(te::da::Sequence* /*sequence*/)
{
  throw te::common::Exception(TE_TR("The method addSequence() is not supported by the WMS driver!"));
}

void te::ws::ogc::wms::da::Transactor::dropSequence(const std::string& /*name*/)
{
  throw te::common::Exception(TE_TR("The method dropSequence() is not supported by the WMS driver!"));
}
...
{
  throw te::common::Exception(TE_TR("The method createDataSet() is not supported by the WMS driver!"));
}
...
void te::ws::ogc::wms::da::Transactor::cloneDataSet(const std::string& /*name*/,
                                       ...
                                       const std::map<std::string, std::string>& /*options*/)
{
  throw te::common::Exception(TE_TR("The method cloneDataSet() is not supported by the WMS driver!"));
}

void te::ws::ogc::wms::da::Transactor::dropDataSet(const std::string& /*name*/)
{
  throw te::common::Exception(TE_TR("The method dropDataSet() is not supported by the WMS driver!"));
}

void te::ws::ogc::wms::da::Transactor::renameDataSet(const std::string& /*name*/,
                                        const std::string& /*newName*/)
{
  throw te::common::Exception(TE_TR("The method renameDataSet() is not supported by the WMS driver!"));
}
...
void te::ws::ogc::wms::da::Transactor::add(const std::string& /*datasetName*/,
                              ...
                              std::size_t /*limit*/)
{
  throw te::common::Exception(TE_TR("The method add() is not supported by the WMS driver!"));
}

void te::ws::ogc::wms::da::Transactor::remove(const std::string& /*datasetName*/, const te::da::ObjectIdSet* /*oids*/)
{
  throw te::common::Exception(TE_TR("The method remove() is not supported by the WMS driver!"));
}
...
void te::ws::ogc::wms::da::Transactor::update(const std::string& /*datasetName*/,
                                 ...
                                 std::size_t /*limit*/)
{
  throw te::common::Exception(TE_TR("The method update() is not supported by the WMS driver!"));
}

void te::ws::ogc::wms::da::Transactor::optimize(const std::map<std::string, std::string>& /*opInfo*/)
{
  throw te::common::Exception(TE_TR("The method optimize() is not supported by the WMS driver!"));
}
