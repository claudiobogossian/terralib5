...
/*!
  \file terralib/dataaccess/memory/DataSetItem.h

  \brief An implementation of the DatasetItem class for the TerraLib In-Memory Data Access driver.
*/

#ifndef __TERRALIB_DATAACCESS_MEMORY_INTERNAL_DATASETITEM_H
#define __TERRALIB_DATAACCESS_MEMORY_INTERNAL_DATASETITEM_H
      ...
      */
      class TEMEMORYEXPORT DataSetItem
      {
        public:
          ...
          */
          explicit DataSetItem(const te::da::core::DataSet* parent);
          ...
          */
          ...
          te::da::core::DataSet* getParent() const;
        ...
        protected:
          ...
          const te::da::core::DataSet* m_parent;                                    //!< The parent dataset if the item is associate to one.
...
#endif  // __TERRALIB_DATAACCESS_MEMORY_INTERNAL_DATASETITEM_H
