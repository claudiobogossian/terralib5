  ...
  namespace rp
  {
    ...
    class Module : public te::common::Singleton<Module>
    {
      ...
      public :
         ...
         */
        TERPEXPORT static const std::string& getLastLogStr() { return m_lastLogString; };

        /*!
          \brief Set the last log string generated by this module.
         */        
        TERPEXPORT static void setLastLogStr( const std::string& errorStr ) { m_lastLogString = errorStr; };
