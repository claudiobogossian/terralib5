...
#ifndef __TERRALIB_MAPTOOLS_INTERNAL_LAYERRENDERER_H
#define __TERRALIB_MAPTOOLS_INTERNAL_LAYERRENDERER_H
...
// Forward declarations
  ...
  {    
     ...
     */
    class TEMAPEXPORT LayerRenderer : public AbstractRenderer
    {
      public:
      ...
      protected:
        ...
        /** @name LayerRenderer Specific Methods
         *  Methods Specific of a LayerRenderer.
         */
        //@{
        ...
        /*!
          ...
          \param srid   The SRS to be used to draw the layer objects.
         */
        void draw(Layer* layer, te::se::FeatureTypeStyle* style, Canvas* canvas, 
        ...
        /*!
          ...
          \param srid   The SRS to be used to draw the layer objects.
         */
        void draw(Layer* layer, te::se::CoverageStyle* style, Canvas* canvas,
                  const te::gm::Envelope& bbox, int srid);
...
#endif  // __TERRALIB_MAPTOOLS_INTERNAL_LAYERRENDERER_H
