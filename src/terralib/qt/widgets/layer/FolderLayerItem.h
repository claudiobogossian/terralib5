...
/*!
  \file FolderLayerItem.h

  \brief A widget designed to show the information of a FolderLayer in a tree oriented way.
 */

#ifndef __TERRALIB_QT_WIDGETS_INTERNAL_FOLDERLAYERITEM_H
#define __TERRALIB_QT_WIDGETS_INTERNAL_FOLDERLAYERITEM_H
...
// Forward declarations
  namespace map { class FolderLayer; }
  ...
  namespace qt
  {
    namespace widgets
    {
      /*!
        ...
        \brief A widget designed to show the information of a FeatureLayer in a tree oriented way.
       */
      class TEQTWIDGETSEXPORT FolderLayerItem : public AbstractLayerItem
      {
        Q_OBJECT
        ...
        public:
          ...
          /*!
            ...
            \note The FolderLayerItem will NOT take the ownership of the referenced layer.
                  Be sure not to clear it before dropping off the FolderLayerItem.
           */
          FolderLayerItem(te::map::AbstractLayer* refLayer, QObject* parent = 0);
...
#endif  // __TERRALIB_QT_WIDGETS_INTERNAL_FOLDERLAYERITEM_H
