...
void GribPolygonExample()
{
  try
  {
    ...
    //rinfo["URI"] = ""TE_DATA_EXAMPLE_LOCALE"/data/rasters/Z500.grb";

    //te::rst::Raster* graster = te::rst::RasterFactory::open("GRIB", rinfo);

    std::auto_ptr<te::rst::Raster> iraster(te::rst::RasterFactory::open("URI", ""TE_DATA_EXAMPLE_LOCALE"/data/rasters/cbers2b_rgb342_crop.tif"));
    ...
    routinfo["URI"] = ""TE_DATA_EXAMPLE_LOCALE"/data/rasters/Z500_out.tif";
