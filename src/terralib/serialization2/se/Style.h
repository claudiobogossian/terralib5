...
/*!
  \file terralib/serialization/se/Style.h
   
  \brief Auxiliary classes and functions to serialize style informations from a XML document.
*/

#ifndef __TERRALIB_SERIALIZATION_SE_INTERNAL_STYLE_H
#define __TERRALIB_SERIALIZATION_SE_INTERNAL_STYLE_H
...
namespace te
{
  ...
  namespace serialize
  {
    class TESERIALIZATIONEXPORT Style : public te::common::Singleton<Style>
    {
...
#endif  // __TERRALIB_SERIALIZATION_SE_INTERNAL_STYLE_H
