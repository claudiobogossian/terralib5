...
#ifndef __TERRALIB_LAYOUT_INTERNAL_SYSTEMATIC_SCALE_OUTSIDE_FACTORY_H
#define __TERRALIB_LAYOUT_INTERNAL_SYSTEMATIC_SCALE_OUTSIDE_FACTORY_H
...
namespace te
{
  namespace layout
  {
    ...
    */
    class TELAYOUTEXPORT SystematicScaleOutsideFactory : public NewOutsideFactory
    {
      public:

        /*! It register the factory in the abstract dictionary. */
        SystematicScaleOutsideFactory();
