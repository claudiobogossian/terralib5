...
/*!
  \file terralib/dataaccess/core/query/ST_Transform.h

  \brief Spatial reference system transformation function.
*/

#ifndef __TERRALIB_DATAACCESS_CORE_QUERY_INTERNAL_ST_TRANSFORM_H
#define __TERRALIB_DATAACCESS_CORE_QUERY_INTERNAL_ST_TRANSFORM_H
...
namespace te
{
  namespace da
  {
    ...
    {
      /*!
        \class terralib/dataaccess/core/query/ST_Transform
...
#endif  // __TERRALIB_DATAACCESS_CORE_QUERY_INTERNAL_ST_TRANSFORM_H
