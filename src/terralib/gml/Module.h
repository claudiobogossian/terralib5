...
#ifndef __TERRALIB_GML_INTERNAL_MODULE_H
#define __TERRALIB_GML_INTERNAL_MODULE_H
    ...
    */
    class Module : public te::common::Singleton<Module>
    {
      ...
      private:
        ...
        /*!
          \brief This is the startup function for the TerraLib GML module.
        ...
        */
        ...
        /*!
          \brief This is the cleanup function for the TerraLib GML module.
...
#endif  // __TERRALIB_GML_INTERNAL_MODULE_H
