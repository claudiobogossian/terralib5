...
/*!
  \file terralib/qt/widgets/datasource/connector/gdal/GDALConnector.cpp
...
te::qt::widgets::GDALConnector::GDALConnector(QWidget* parent, Qt::WindowFlags f)
  : AbstractDataSourceConnector(parent, f)
{
}

te::qt::widgets::GDALConnector::~GDALConnector()
{
}

void te::qt::widgets::GDALConnector::create(std::list<DataSourcePtr>& datasources)
{
...
void te::qt::widgets::GDALConnector::update(std::list<DataSourcePtr>& datasources)
{
...
void te::qt::widgets::GDALConnector::remove(std::list<DataSourcePtr>& datasources)
{
  for(std::list<DataSourcePtr>::iterator it = datasources.begin(); it != datasources.end(); ++it)
  {
    if(it->get() == 0)
