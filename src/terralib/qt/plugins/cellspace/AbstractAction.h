...
#ifndef __TE_QT_PLUGINS_CELLSPACE_INTERNAL_ABSTRACTACTION_H
#define __TE_QT_PLUGINS_CELLSPACE_INTERNAL_ABSTRACTACTION_H
    ...
    namespace plugins
    {
      namespace cellspace
      {
        /*!
          ...
          \brief This is an abstract class used to register actions into Cellular Spaces pluging.
...
#endif //__TE_QT_PLUGINS_CELLSPACE_INTERNAL_ABSTRACTACTION_H