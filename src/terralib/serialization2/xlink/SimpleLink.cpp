...
/*!
  \file terralib/serialization/xlink/SimpleLink.cpp
...
te::xl::SimpleLink* te::serialize::ReadSimpleLink(te::xml::Reader& reader)
{
...
void te::serialize::Save(const te::xl::SimpleLink* link, te::xml::Writer& writer)
{
  assert(link);
