...
te::layout::OutsideFactory::OutsideFactory(const std::string& factoryKey)
: te::common::ParameterizedAbstractFactory<AbstractOutsideView, std::string, OutsideFactoryParamsCreate>(factoryKey)
{

}

void te::layout::OutsideFactory::setProperties(AbstractOutsideModel* model, OutsideFactoryParamsCreate params)
{
  // do nothing
}
