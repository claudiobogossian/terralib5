...
// create output raster for linear mixture model
  ...
  orinfo["URI"] = TE_DATA_LOCALE"/data/rasters/cbers2b_rgb342_crop_linearMixtureModel.tif";
...
// create output raster for PCA mixture model
  std::map<std::string, std::string> orinfo;
  orinfo["URI"] = TE_DATA_LOCALE"/data/rasters/cbers2b_rgb342_crop_PCAMixtureModel.tif";
