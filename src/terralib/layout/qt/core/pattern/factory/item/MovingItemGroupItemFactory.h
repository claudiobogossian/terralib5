...
/*!
  \file terralib/layout/qt/core/pattern/factory/MovingItemGroupItemFactory.h

  \brief This is the concrete factory for moving item group item.
 */

#ifndef __TERRALIB_LAYOUT_INTERNAL_MOVINGITEMGROUP_ITEM_FACTORY_H
#define __TERRALIB_LAYOUT_INTERNAL_MOVINGITEMGROUP_ITEM_FACTORY_H
...
namespace te
{
  namespace layout
  {
    ...
    /*!
      \class MovingItemGroupItemFactory

      \brief This is the concrete factory for  moving item group item.

      \sa NewItemFactory, ParameterizedAbstractFactory, AbstractItemView
    */
    class TELAYOUTEXPORT MovingItemGroupItemFactory : public NewItemFactory
    {
      public:

        /*! It register the factory in the abstract dictionary. */
        MovingItemGroupItemFactory();
