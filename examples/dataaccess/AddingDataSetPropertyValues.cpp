...
void AddingDataSetPropertyValues(te::da::DataSet* /*ds*/)
{
  ...
  //{
  //  std::cout << std::endl << "An exception has occurried in Adding DataSet Property Values Example: " << e.what() << std::endl;
  //}
  //catch(...)
  //{
  //  std::cout << std::endl << "An unexpected exception has occurried in Adding DataSet Property Values Example!" << std::endl;
  //}
}
