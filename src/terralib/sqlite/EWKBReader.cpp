...
// initial byte must be 0x00
  if((ewkb[0] != GAIA_MARK_START) || (ewkb[38] != GAIA_MARK_MBR))
    throw Exception(TR_SQLITE("It is an invalid SpatiaLite geometry!"));
                                                      ...
                                                      te::gm::Envelope* mbr)
{
  ...
  *endptr = ewkb;
  ...
  switch(gType)
  {
    ...
    default:
      throw Exception(TR_SQLITE("This kind of geometry id not supported by SpatiaLite!"));
  }
}
  ...
  *endptr = ewkb;
  ...
  for(unsigned int i = 0; i < nGeoms; ++i)
  {
    ...
    switch(classtype)
    {
      ...
      default:
        throw Exception(TR_SQLITE("This kind of geometry is not handled by TerraLib SpatiaLite driver yet!"));
    }
