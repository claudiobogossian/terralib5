...
/*!
  \file terralib/layout/qt/core/pattern/factory/EllipseItemFactory.h

  \brief This is the concrete factory for ellipse item.
 */

#ifndef __TERRALIB_LAYOUT_INTERNAL_ELLIPSE_ITEM_FACTORY_H
#define __TERRALIB_LAYOUT_INTERNAL_ELLIPSE_ITEM_FACTORY_H
...
namespace te
{
  namespace layout
  {
    ...
    /*!
      \class EllipseItemFactory

      \brief This is the concrete factory for ellipse item.

      \sa NewItemFactory, ParameterizedAbstractFactory, AbstractItemView
    */
    class TELAYOUTEXPORT EllipseItemFactory : public NewItemFactory
    {
      public:
