...
#ifndef __TERRALIB_QT_WIDGETS_PROPERTY_INTERNAL_NUMERICPROPERTYWIDGETFACTORY_H
#define __TERRALIB_QT_WIDGETS_PROPERTY_INTERNAL_NUMERICPROPERTYWIDGETFACTORY_H
...
namespace te
{
  ...
  {   
    namespace widgets
    {
      ...
      */
      class TEQTWIDGETSEXPORT NumericPropertyWidgetFactory : public te::qt::widgets::SimplePropertyWidgetFactory
      {
        public:
        ...
        private:
          ...
          static NumericPropertyWidgetFactory* sm_factory;
...
#endif // __TERRALIB_QT_WIDGETS_PROPERTY_INTERNAL_NUMERICPROPERTYWIDGETFACTORY_H