...
/*!
  \file MemoryGraphFactory.h

  \brief This is the concrete factory for the memory Graph type.
*/

#ifndef __TERRALIB_GRAPH_INTERNAL_MEMORYGRAPHFACTORY_H
#define __TERRALIB_GRAPH_INTERNAL_MEMORYGRAPHFACTORY_H
...
namespace te
{
  ...
  {
    /*!
      \class MemoryGraphFactory

      \brief This is the concrete factory for the memory Graph type.

      \sa te::graph::AbstractGraphFactory
    */
    class TEGRAPHEXPORT MemoryGraphFactory : public te::graph::AbstractGraphFactory
    {
      public:
      ...
      private:
        ...
        static MemoryGraphFactory* sm_factory;    //!< Static instance used to register the factory
...
#endif  // __TERRALIB_GRAPH_INTERNAL_MEMORYGRAPHFACTORY_H
