...
/*!
  \file terralib/dataccess/memory/Band.cpp
...
te::da::mem::Band::Band(Raster* r, te::rst::BandProperty* p, std::size_t idx, void* externalBuffer)
  : te::rst::Band(p, idx),
    m_raster(r),
    m_buff(0),
    m_getBuff(0),
...
te::da::mem::Band::Band(const Band& rhs)
  : te::rst::Band(rhs),
    m_raster(0),
    m_buff(0),
...
te::rst::Raster* te::da::mem::Band::getRaster() const
{
  return m_raster;
}

te::da::mem::Band& te::da::mem::Band::operator=(const Band& rhs)
{
  if(&rhs != this)
  {
...
void te::da::mem::Band::getValue(unsigned int c, unsigned int r, double& value) const
{
  int pos = c + r * m_ncols;
...
void te::da::mem::Band::setValue(unsigned int c, unsigned int r, const double value)
{
  int pos = c + r * m_ncols;
...
void te::da::mem::Band::getIValue(unsigned int c, unsigned int r, double& value) const
{
  int pos = c + r * m_ncols;
...
void te::da::mem::Band::setIValue(unsigned int c, unsigned int r, const double value)
{
  int pos = c + r * m_ncols;
...
void te::da::mem::Band::read(int x, int y, void* buffer) const
{
  assert(x == 0 && y == 0);
...
void* te::da::mem::Band::read(int x, int y)
{
  assert(x == 0 && y == 0);
...
void te::da::mem::Band::write(int x, int y, void* buffer)
{
  assert(x == 0 && y == 0);
...
void te::da::mem::Band::setRaster(Raster* r)
{
  m_raster = r;
}

int te::da::mem::Band::getBlockSize() const
{
  return m_blksize;
}
