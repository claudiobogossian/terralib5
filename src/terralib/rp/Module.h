  ...
  namespace rp
  {
    ...
    class Module : public te::common::Singleton<Module>
    {
      ...
      public :
         ...
         */
        static const std::string& TERPEXPORT getLastLogStr() { return m_lastLogString; };

        /*!
          \brief Set the last log string generated by this module.
         */        
        static void TERPEXPORT setLastLogStr( const std::string& errorStr ) { m_lastLogString = errorStr; };
