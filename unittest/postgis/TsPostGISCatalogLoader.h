...
#ifndef __TERRALIB_UNITTEST_DATAACCESS_INTERNAL_POSTGISCATALOGLOADER_H
#define __TERRALIB_UNITTEST_DATAACCESS_INTERNAL_POSTGISCATALOGLOADER_H
...
class TsPostGISCatalogLoader : public TsDataSourceCatalogLoader
{
// It registers this class as a Test Suit
  CPPUNIT_TEST_SUITE( TsPostGISCatalogLoader );
...
// Adding specific Test cases for PostGIS (TsPostGISCatalogLoader)
...
#endif  // __TERRALIB_UNITTEST_DATAACCESS_INTERNAL_POSTGISCATALOGLOADER_H
