...
#ifndef __TERRALIB_QT_PLUGINS_LAYOUT2_INTERNAL_CONFIG_H
#define __TERRALIB_QT_PLUGINS_LAYOUT2_INTERNAL_CONFIG_H
...
*/
#define TE_QT_PLUGIN_LAYOUT2_HAVE_LAYOUTEDITOR
...
*/
#define TE_QT_PLUGIN_LAYOUT2_PLUGIN_NAME "te.qt.layout2"
...
*/
#define TE_QT_PLUGIN_LAYOUT2_TEXT_DOMAIN "teqtpluginlayout2"
...
*/
#define TE_QT_PLUGIN_LAYOUT2_TEXT_DOMAIN_DIR "locale"
...
*/
#define TE_QT_PLUGIN_LAYOUT2(message) TR(message, TE_QT_PLUGIN_LAYOUT2_TEXT_DOMAIN)
 ...
 */
#ifdef WIN32
  #ifdef TEQTPLUGINLAYOUT2DLL
    #define TEQTPLUGINLAYOUT2EXPORT  __declspec(dllexport)   // export DLL information
  #else
    #define TEQTPLUGINLAYOUT2EXPORT  __declspec(dllimport)   // import DLL information
  #endif 
#else
  #define TEQTPLUGINLAYOUT2EXPORT
#endif
