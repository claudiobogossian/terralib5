...
#ifndef __TERRALIB_BINDING_V8_COMMON_INTERNAL_MODULE_H
#define __TERRALIB_BINDING_V8_COMMON_INTERNAL_MODULE_H
    ...
    namespace common
    {
      ...
      class Module : public te::common::Singleton<Module>
      {
        ...
        private:
          ...
          /*!
            \brief This is the startup function for the TerraLib V8 Common Runtime module.
          ...
          /*!
            \brief This is the cleanup function for the TerraLib V8 Common Runtime module.
...
#endif  // __TERRALIB_BINDING_V8_COMMON_INTERNAL_MODULE_H
