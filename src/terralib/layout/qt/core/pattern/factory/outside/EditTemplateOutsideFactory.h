...
#ifndef __TERRALIB_LAYOUT_INTERNAL_EDIT_TEMPLATE_OUTSIDE_FACTORY_H
#define __TERRALIB_LAYOUT_INTERNAL_EDIT_TEMPLATE_OUTSIDE_FACTORY_H
...
namespace te
{
  namespace layout
  {
    ...
    */
    class TELAYOUTEXPORT EditTemplateOutsideFactory : public NewOutsideFactory
    {
      public:

        /*! It register the factory in the abstract dictionary. */
        EditTemplateOutsideFactory();
