...
/*!
  \file RectangleLayoutController.h
...
#ifndef __TERRALIB_LAYOUT_INTERNAL_RECTANGLELAYOUT_CONTROLLER_H 
#define __TERRALIB_LAYOUT_INTERNAL_RECTANGLELAYOUT_CONTROLLER_H
