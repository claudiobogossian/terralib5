...
te::edit::VertexCommand::VertexCommand(std::vector<Feature*> items, te::qt::widgets::MapDisplay* display, const te::map::AbstractLayerPtr& layer,
  QUndoCommand *parent) :
  QUndoCommand(parent)
  , m_display(display)
  , m_layer(layer)
...
te::edit::VertexCommand::~VertexCommand()
{}

void  te::edit::VertexCommand::undo()
{
...
void te::edit::VertexCommand::redo()
{
...
void te::edit::VertexCommand::draw(const int commandType)
{
...
QString te::edit::VertexCommand::createCommandString(QString oid)
{
  return QObject::tr("%1")
    .arg(oid);
}