...
/*!
  \file TsMoveGeometry.h
 
  \brief A test suit for the Move Geometry.
 */
...
/*!
  \class TsMoveGeometry

  \brief A test suit for the Move Geometries class interface.

  ....
  <br>
  This test suite will check the Move Geometries class
  </ul>
 */
class TsMoveGeometry : public CPPUNIT_NS::TestFixture
{
// It registers this class as a Test Suit
  CPPUNIT_TEST_SUITE( TsMoveGeometry );
