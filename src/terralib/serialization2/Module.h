...
#ifndef __TERRALIB_SERIALIZATION_INTERNAL_MODULE_H
#define __TERRALIB_SERIALIZATION_INTERNAL_MODULE_H
    ...
    */
    class Module : public te::common::Singleton<Module>
    {
      ...
      private:
        ...
        /*!
          \brief This is the startup function for the TerraLib Serialization module.
        ...
        */
        ...
        /*!
          \brief This is the cleanup function for the TerraLib Serialization module.
...
#endif  // __TERRALIB_SERIALIZATION_INTERNAL_MODULE_H
