...
#ifndef __TERRALIB_ADDRESSGEOCODING_CORE_INTERNAL_MODULE_H
#define __TERRALIB_ADDRESSGEOCODING_CORE_INTERNAL_MODULE_H
...
#endif  // __TERRALIB_ADDRESSGEOCODING_CORE_INTERNAL_MODULE_H
