...
if(WIN32)
  function(_QT4_QUERY_QMAKE VAR RESULT)
    if(${VAR} MATCHES "^QT_VERSION")
      set(output "4.7.3")
    elseif(${VAR} MATCHES "^QT_INSTALL_DATA")
      set(output "$ENV{TERRALIB_DEP_MSVC2010}/qt")
    elseif(${VAR} MATCHES "^QT_INSTALL_DOCS")
      set(output "$ENV{TERRALIB_DEP_MSVC2010}/qt/doc")
    elseif(${VAR} MATCHES "^QT_INSTALL_LIBS")
      set(output "$ENV{TERRALIB_DEP_MSVC2010}/qt/lib")
    elseif(${VAR} MATCHES "^QT_INSTALL_BINS")
      set(output "$ENV{TERRALIB_DEP_MSVC2010}/qt/bin")
    elseif(${VAR} MATCHES "^QT_INSTALL_PREFIX")
      set(output "$ENV{TERRALIB_DEP_MSVC2010}/qt")
    elseif(${VAR} MATCHES "^QT_INSTALL_HEADERS")
      set(output "$ENV{TERRALIB_DEP_MSVC2010}/qt/include")
    elseif(${VAR} MATCHES "^QT_INSTALL_PLUGINS")
      set(output "$ENV{TERRALIB_DEP_MSVC2010}/qt/plugins")
    elseif(${VAR} MATCHES "^QT_INSTALL_IMPORTS")
      set(output "$ENV{TERRALIB_DEP_MSVC2010}/qt/imports")
    elseif(${VAR} MATCHES "^QT_INSTALL_TRANSLATIONS")
      set(output "$ENV{TERRALIB_DEP_MSVC2010}/qt/translations")
    elseif(${VAR} MATCHES "^QT_INSTALL_CONFIGURATION")
      set(output "$ENV{TERRALIB_DEP_MSVC2010}/qt")
    elseif(${VAR} MATCHES "^QT_INSTALL_EXAMPLES")
      set(output "$ENV{TERRALIB_DEP_MSVC2010}/qt/examples")
    elseif(${VAR} MATCHES "^QT_INSTALL_DEMOS")
      set(output "$ENV{TERRALIB_DEP_MSVC2010}/qt/demos")
    elseif(${VAR} MATCHES "^QMAKE_MKSPECS")
      set(output "$ENV{TERRALIB_DEP_MSVC2010}/qt/mkspecs")
    elseif(${VAR} MATCHES "^QMAKE_VERSION")
      set(output "2.01a")
    endif(${VAR} MATCHES "^QT_VERSION")
