...
te::qt::widgets::WMSConnector::WMSConnector(QWidget* parent, Qt::WindowFlags f)
  : AbstractDataSourceConnector(parent, f)
{
}

te::qt::widgets::WMSConnector::~WMSConnector()
{
}

void te::qt::widgets::WMSConnector::create(std::list<DataSourcePtr>& datasources)
{
...
void te::qt::widgets::WMSConnector::update(std::list<DataSourcePtr>& /*datasources*/)
{
...
void te::qt::widgets::WMSConnector::remove(std::list<DataSourcePtr>& /*datasources*/)
{
  QMessageBox::warning(this,
                       tr("TerraLib Qt Components"),
                       tr("Not implemented yet!\nWe will provide it soon!"));
