...
/*!
  \file terralib/dataaccess/core/query/ST_Touches.h

  \brief Spatial touches operator.
*/

#ifndef __TERRALIB_DATAACCESS_CORE_QUERY_INTERNAL_ST_TOUCHES_H
#define __TERRALIB_DATAACCESS_CORE_QUERY_INTERNAL_ST_TOUCHES_H
...
#endif  // __TERRALIB_DATAACCESS_CORE_QUERY_INTERNAL_ST_TOUCHES_H
