...
/*!
  \file terralib/dataaccess/memory/CachedBand.h
 
  \brief RAM cached and tiled raster band.
*/

#ifndef __TERRALIB_DATAACCESS_MEMORY_INTERNAL_CACHEDBAND_H
#define __TERRALIB_DATAACCESS_MEMORY_INTERNAL_CACHEDBAND_H
...
#endif  // __TERRALIB_DATAACCESS_MEMORY_INTERNAL_CACHEDBAND_H
