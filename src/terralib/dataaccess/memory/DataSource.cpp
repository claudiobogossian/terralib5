...
/*!
  \file terralib/dataaccess/memory/DataSource.cpp
...
#include "../core/datasource/DataSourceCatalog.h"
#include "../core/datasource/DataSourceCapabilities.h"
#include "../core/query/SQLDialect.h"
#include "DataSet.h"
...
class te::da::mem::DataSource::Impl
{
  public:
    ...
    te::da::core::DataSetType* getDataSetType(const std::string& name)
    {
      boost::lock_guard<boost::recursive_mutex> lock(m_mtx);

      std::map<std::string, te::da::core::DataSetTypePtr>::const_iterator it = m_schemas.find(name);

      if(it == m_schemas.end())
        return 0;

      return static_cast<te::da::core::DataSetType*>(it->second->clone());
    }
    ...
    std::size_t getNumberOfProperties(const std::string& datasetName)
    {
      ...
      std::map<std::string, te::da::core::DataSetTypePtr>::const_iterator it = m_schemas.find(datasetName);
    ...
    boost::ptr_vector<te::dt::Property> getProperties(const std::string& datasetName)
    {
      ...
      const te::da::core::DataSetTypePtr& dt = it->second;
    ...
    std::map<std::string, te::da::core::DataSetTypePtr> m_schemas;  //!< The set of dataset schemas.
    ...
    static te::da::core::DataSourceCapabilities sm_capabilities;    //!< The Memory data source capabilities.
    static const te::da::core::SQLDialect sm_dialect;               //!< A dummy dialect.
};

te::da::core::DataSourceCapabilities te::da::mem::DataSource::Impl::sm_capabilities;

const te::da::core::SQLDialect te::da::mem::DataSource::Impl::sm_dialect;

te::da::mem::DataSource::DataSource()
  : m_pImpl(0)
{
  m_pImpl = new Impl;
}
...
std::string te::da::mem::DataSource::getType() const throw()
{
  return TE_MEMORY_DRIVER_IDENTIFIER;
}

const std::map<std::string, std::string>& te::da::mem::DataSource::getConnectionInfo() const throw()
{
  return m_pImpl->m_connInfo;
}

void te::da::mem::DataSource::setConnectionInfo(const std::map<std::string, std::string>& connInfo) throw()
{
  m_pImpl->m_connInfo = connInfo;
}

void te::da::mem::DataSource::open() throw(te::da::core::Exception)
{
...
void te::da::mem::DataSource::close() throw(te::da::core::Exception)
{
...
bool te::da::mem::DataSource::isOpened() const throw()
{
  return m_pImpl->m_isOpened;
}

bool te::da::mem::DataSource::isValid() const throw()
{
  return m_pImpl->m_isOpened;
}

const te::da::core::DataSourceCapabilities& te::da::mem::DataSource::getCapabilities() const throw()
{
  return Impl::sm_capabilities;
}

const te::da::core::SQLDialect* te::da::mem::DataSource::getDialect() const throw()
{
  return &Impl::sm_dialect;
}

void te::da::mem::DataSource::begin() throw(te::da::core::Exception)
{
// Not supported by In-Memory driver!
}

void te::da::mem::DataSource::commit() throw(te::da::core::Exception)
{
// Not supported by In-Memory driver!
}

void te::da::mem::DataSource::rollBack() throw(te::da::core::Exception)
{
// Not supported by In-Memory driver!
}

bool te::da::mem::DataSource::isInTransaction() const throw()
{
  return false;
}

std::auto_ptr<te::da::core::DataSet> te::da::mem::DataSource::getDataSet(const std::string& name,
                                                                         te::common::TraverseType /*travType*/) throw(te::da::core::Exception)
{

  DataSet* d = m_pImpl->getDataSet(name);

  return std::auto_ptr<te::da::core::DataSet>(d);
}
...
std::auto_ptr<te::da::core::DataSet> te::da::mem::DataSource::query(const te::da::core::Select& /*q*/,
                                                                    te::common::TraverseType /*travType*/) throw(te::da::core::Exception)
{
  throw Exception(TR_MEMORY("Not implemented yet!"));
}

std::auto_ptr<te::da::core::DataSet> te::da::mem::DataSource::query(const std::string& /*query*/, 
                                                                    te::common::TraverseType /*travType*/) throw(te::da::core::Exception)
{
  throw Exception(TR_MEMORY("Not implemented yet!"));
}

void te::da::mem::DataSource::execute(const te::da::core::Query& /*command*/) throw(te::da::core::Exception)
{
  throw Exception(TR_MEMORY("Not implemented yet!"));
}

void te::da::mem::DataSource::execute(const std::string& /*command*/) throw(te::da::core::Exception)
{
  throw Exception(TR_MEMORY("Not implemented yet!"));
}

void te::da::mem::DataSource::cancel() throw(te::da::core::Exception)
{
}

boost::int64_t te::da::mem::DataSource::getLastGeneratedId() throw(te::da::core::Exception)
{
  return 0;
}

std::string te::da::mem::DataSource::escape(const std::string& value) throw(te::da::core::Exception)
{
  return value;
}

bool te::da::mem::DataSource::isDataSetNameValid(const std::string& /*datasetName*/) throw(te::da::core::Exception)
{
  return true;
}

bool te::da::mem::DataSource::isPropertyNameValid(const std::string& /*propertyName*/) throw(te::da::core::Exception)
{
  return true;
}

std::vector<std::string> te::da::mem::DataSource::getDataSetNames() throw(te::da::core::Exception)
{
  return m_pImpl->getDataSets();
}

std::auto_ptr<te::da::core::DataSetType> te::da::mem::DataSource::getDataSetType(const std::string& name) throw(te::da::core::Exception)
{
  return std::auto_ptr<te::da::core::DataSetType>(m_pImpl->getDataSetType(name));
}

std::size_t te::da::mem::DataSource::getNumberOfProperties(const std::string& datasetName) throw(te::da::core::Exception)
{
  return m_pImpl->getNumberOfProperties(datasetName);
}

boost::ptr_vector<te::dt::Property> te::da::mem::DataSource::getProperties(const std::string& datasetName) throw(te::da::core::Exception)
{
  return m_pImpl->getProperties(datasetName);
}

std::auto_ptr<te::dt::Property>te::da::mem::DataSource:: getProperty(const std::string& datasetName,
                                                                     const std::string& propertyName) throw(te::da::core::Exception)
{
  return std::auto_ptr<te::dt::Property>(m_pImpl->getProperty(datasetName, propertyName));
}

std::auto_ptr<te::dt::Property> te::da::mem::DataSource::getProperty(const std::string& datasetName,
                                                                     std::size_t propertyPos) throw(te::da::core::Exception)
{
  return std::auto_ptr<te::dt::Property>(m_pImpl->getProperty(datasetName, propertyPos));
}

std::auto_ptr<te::da::core::PrimaryKey> te::da::mem::DataSource::getPrimaryKey(const std::string& /*datasetName*/) throw(te::da::core::Exception)
{
  throw Exception(TR_MEMORY("Not implemented yet!"));
}

std::vector<std::string> te::da::mem::DataSource::getUniqueKeyNames(const std::string& /*datasetName*/) throw(te::da::core::Exception)
{
  throw Exception(TR_MEMORY("Not implemented yet!"));
}

boost::ptr_vector<te::da::core::UniqueKey> te::da::mem::DataSource::getUniqueKeys(const std::string& /*datasetName*/) throw(te::da::core::Exception)
{
  throw Exception(TR_MEMORY("Not implemented yet!"));
}

std::auto_ptr<te::da::core::UniqueKey> te::da::mem::DataSource::getUniqueKey(const std::string& /*datasetName*/,
                                                                             const std::string& /*name*/) throw(te::da::core::Exception)
{
  throw Exception(TR_MEMORY("Not implemented yet!"));
}

std::vector<std::string> te::da::mem::DataSource::getForeignKeyNames(const std::string& /*datasetName*/) throw(te::da::core::Exception)
{
  throw Exception(TR_MEMORY("Not implemented yet!"));
}

std::auto_ptr<te::da::core::ForeignKey> te::da::mem::DataSource::getForeignKey(const std::string& /*datasetName*/,
                                                                               const std::string& /*name*/) throw(te::da::core::Exception)
{
  throw Exception(TR_MEMORY("Not implemented yet!"));
}

std::vector<std::string> te::da::mem::DataSource::getIndexNames(const std::string& /*datasetName*/) throw(te::da::core::Exception)
{
  throw Exception(TR_MEMORY("Not implemented yet!"));
}

std::auto_ptr<te::da::core::Index> te::da::mem::DataSource::getIndex(const std::string& /*datasetName*/,
                                                                     const std::string& /*name*/) throw(te::da::core::Exception)
{
  throw Exception(TR_MEMORY("Not implemented yet!"));
}

std::vector<std::string> te::da::mem::DataSource::getCheckConstraintNames(const std::string& /*datasetName*/) throw(te::da::core::Exception)
{
  throw Exception(TR_MEMORY("Not implemented yet!"));
}

std::auto_ptr<te::da::core::CheckConstraint> te::da::mem::DataSource::getCheckConstraint(const std::string& /*datasetName*/,
                                                                                         const std::string& /*name*/) throw(te::da::core::Exception)
{
  throw Exception(TR_MEMORY("Not implemented yet!"));
}

std::vector<std::string> te::da::mem::DataSource::getSequenceNames() throw(te::da::core::Exception)
{
  throw Exception(TR_MEMORY("Not implemented yet!"));
}

std::auto_ptr<te::da::core::Sequence> te::da::mem::DataSource::getSequence(const std::string& /*name*/) throw(te::da::core::Exception)
{
  throw Exception(TR_MEMORY("Not implemented yet!"));
}

std::auto_ptr<te::gm::Envelope> te::da::mem::DataSource::getExtent(const std::string& /*datasetName*/,
                                                                   const std::string& /*propertyName*/) throw(te::da::core::Exception)
{
  throw Exception(TR_MEMORY("Not implemented yet!"));
}
...
std::size_t te::da::mem::DataSource::getNumberOfItems(const std::string& /*datasetName*/) throw(te::da::core::Exception)
{
  throw Exception(TR_MEMORY("Not implemented yet!"));
}

bool te::da::mem::DataSource::hasDataSets() throw(te::da::core::Exception)
{
  throw Exception(TR_MEMORY("Not implemented yet!"));
}

bool te::da::mem::DataSource::datasetExists(const std::string& /*name*/) throw(te::da::core::Exception)
{
  throw Exception(TR_MEMORY("Not implemented yet!"));
}

bool te::da::mem::DataSource::primarykeyExists(const std::string& /*datasetName*/,
                                               const std::string& /*name*/) throw(te::da::core::Exception)
{
  throw Exception(TR_MEMORY("Not implemented yet!"));
}

bool te::da::mem::DataSource::uniquekeyExists(const std::string& /*datasetName*/,
                                              const std::string& /*name*/) throw(te::da::core::Exception)
{
  throw Exception(TR_MEMORY("Not implemented yet!"));
}

bool te::da::mem::DataSource::foreignkeyExists(const std::string& /*datasetName*/,
                                               const std::string& /*name*/) throw(te::da::core::Exception)
{
  throw Exception(TR_MEMORY("Not implemented yet!"));
}

bool te::da::mem::DataSource::checkConstraintExists(const std::string& /*datasetName*/,
                                                    const std::string& /*name*/) throw(te::da::core::Exception)
{
  throw Exception(TR_MEMORY("Not implemented yet!"));
}

bool te::da::mem::DataSource::indexExists(const std::string& /*datasetName*/,
                                          const std::string& /*name*/) throw(te::da::core::Exception)
{
  throw Exception(TR_MEMORY("Not implemented yet!"));
}

bool te::da::mem::DataSource::sequenceExists(const std::string& /*name*/) throw(te::da::core::Exception)
{
  throw Exception(TR_MEMORY("Not implemented yet!"));
}

void te::da::mem::DataSource::createDataSet(te::da::core::DataSetType* dt,
...
void te::da::mem::DataSource::cloneDataSet(const std::string& /*name*/,
...
void te::da::mem::DataSource::dropDataSet(const std::string& /*name*/) throw(te::da::core::Exception)
{
...
void te::da::mem::DataSource::renameDataSet(const std::string& /*name*/,
...
void te::da::mem::DataSource::addProperty(const std::string& /*datasetName*/,
...
void te::da::mem::DataSource::dropProperty(const std::string& /*datasetName*/,
                                           const std::string& /*propertyName*/) throw(te::da::core::Exception)
{
  //DataSource* ds = m_t->getMemDataSource();
...
void te::da::mem::DataSource::renameProperty(const std::string& /*datasetName*/,
                                             const std::string& /*propertyName*/,
...
void te::da::mem::DataSource::addPrimaryKey(const std::string& /*datasetName*/,
...
void te::da::mem::DataSource::dropPrimaryKey(const std::string& /*datasetName*/,
...
void te::da::mem::DataSource::addUniqueKey(const std::string& /*datasetName*/,
...
void te::da::mem::DataSource::dropUniqueKey(const std::string& /*datasetName*/,
...
void te::da::mem::DataSource::addIndex(const std::string& /*datasetName*/,
...
void te::da::mem::DataSource::dropIndex(const std::string& /*datasetName*/,
...
void te::da::mem::DataSource::addForeignKey(const std::string& /*datasetName*/,
...
void te::da::mem::DataSource::dropForeignKey(const std::string& /*datasetName*/,
...
void te::da::mem::DataSource::addCheckConstraint(const std::string& /*datasetName*/,
...
void te::da::mem::DataSource::dropCheckConstraint(const std::string& /*datasetName*/,
                                                  const std::string& /*name*/) throw(te::da::core::Exception)
{
  //DataSource* ds = m_t->getMemDataSource();
...
void te::da::mem::DataSource::createSequence(const te::da::core::Sequence* /*sequence*/) throw(te::da::core::Exception)
{
  //DataSource* ds = m_t->getMemDataSource();
...
void te::da::mem::DataSource::dropSequence(const std::string& /*name*/) throw(te::da::core::Exception)
{
  //DataSource* ds = m_t->getMemDataSource();
...
void te::da::mem::DataSource::add(const std::string& /*datasetName*/,
...
void te::da::mem::DataSource::remove(const std::string& /*datasetName*/,
...
void te::da::mem::DataSource::update(const std::string& /*datasetName*/,
...
void te::da::mem::DataSource::create(const std::map<std::string, std::string>& dsInfo) throw(te::da::core::Exception)
{
...
void te::da::mem::DataSource::drop(const std::map<std::string, std::string>& /*dsInfo*/) throw(te::da::core::Exception)
{
// Not supported by In-Memory driver!
}

bool te::da::mem::DataSource::exists(const std::map<std::string, std::string>& /*dsInfo*/) throw(te::da::core::Exception)
{
// Not supported by In-Memory driver!
  return false;
}

std::vector<std::string> te::da::mem::DataSource::getDataSourceNames(const std::map<std::string, std::string>& /*info*/) throw(te::da::core::Exception)
{
