...
/*!
  \file terralib/dataaccess/query/ST_IsValid.h

  \brief Spatial is valid operator.
*/

#ifndef __TERRALIB_DATAACCESS_INTERNAL_ST_ISVALID_H
#define __TERRALIB_DATAACCESS_INTERNAL_ST_ISVALID_H
...
namespace te
{
  ...
  namespace da
  {
    /*!
      ...
      \sa Function
    */
    class TEDATAACCESSEXPORT ST_IsValid : public Function
    {
      public:
        ...
        */
        ST_IsValid(const te::gm::Geometry& g);
...
#endif  // __TERRALIB_DATAACCESS_INTERNAL_ST_ISVALID_H
