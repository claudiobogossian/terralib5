...
/*!
  \file PropertiesWindowLayoutModel.h
...
#ifndef __TERRALIB_LAYOUT_INTERNAL_PROPERTIESWINDOW_LAYOUTMODEL_H
#define __TERRALIB_LAYOUT_INTERNAL_PROPERTIESWINDOW_LAYOUTMODEL_H
