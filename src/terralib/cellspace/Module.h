...
/*!
  \file terralib/cellspace/Module.h
   
  \brief This singleton defines the TerraLib Cellular Spaces module entry.
*/

#ifndef __TERRALIB_CELLSPACE_INTERNAL_MODULE_H
#define __TERRALIB_CELLSPACE_INTERNAL_MODULE_H
    ...
    */
    class Module : public te::common::Singleton<Module>
    {
      ...
      private:
        ...
        /*!
          \brief This is the startup function for the TerraLib Cellular Spaces module.
        ...
        */
        ...
        /*!
          \brief This is the cleanup function for the TerraLib Cellular Spaces module.
...
#endif  // __TERRALIB_CELLSPACE_INTERNAL_MODULE_H
