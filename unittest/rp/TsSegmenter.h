...
/*!
  ...
  \brief A test suit for the Segmenter Class.
 */

#ifndef __TERRALIB_UNITTEST_RP_SEGMENTER_INTERNAL_H
#define __TERRALIB_UNITTEST_RP_SEGMENTER_INTERNAL_H
...
/*!
  ...
  \brief A test suit for the Segmenter class interface.

  ....
  <br>
  This test suite will check the Segmenter class
  </ul>
 */
class TsSegmenter : public CPPUNIT_NS::TestFixture 
{
  ...
  protected :
    ...
    void BlockProcessingWithMerging();
