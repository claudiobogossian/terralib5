...
#ifndef __TERRALIB_GRAPH_INTERNAL_TOPDOWNLOADERSTRATEGY_H
#define __TERRALIB_GRAPH_INTERNAL_TOPDOWNLOADERSTRATEGY_H
...
namespace te
{
  namespace graph
  {
    ...
    */
    ...
    class TEGRAPHEXPORT TopDownLoaderStrategy : public AbstractGraphLoaderStrategy
    {
      public:

        /*! \brief Default constructor. */
    TopDownLoaderStrategy(te::graph::GraphMetadata* metadata) : AbstractGraphLoaderStrategy(metadata) {};
...
#endif // __TERRALIB_GRAPH_INTERNAL_TOPDOWNLOADERSTRATEGY_H