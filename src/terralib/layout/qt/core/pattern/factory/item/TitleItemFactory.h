...
/*!
  \file terralib/layout/qt/core/pattern/factory/TitleItemFactory.h

  \brief This is the concrete factory for title item.
 */

#ifndef __TERRALIB_LAYOUT_INTERNAL_TITLE_ITEM_FACTORY_H
#define __TERRALIB_LAYOUT_INTERNAL_TITLE_ITEM_FACTORY_H
...
namespace te
{
  namespace layout
  {
    ...
    /*!
      \class TitleItemFactory

      \brief This is the concrete factory for title item.

      \sa NewItemFactory, ParameterizedAbstractFactory, AbstractItemView
    */
    class TELAYOUTEXPORT TitleItemFactory : public NewItemFactory
    {
      public:
