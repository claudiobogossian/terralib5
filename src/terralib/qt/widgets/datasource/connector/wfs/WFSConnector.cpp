...
te::qt::widgets::WFSConnector::WFSConnector(QWidget* parent, Qt::WindowFlags f)
  : AbstractDataSourceConnector(parent, f)
{
}

te::qt::widgets::WFSConnector::~WFSConnector()
{
}

void te::qt::widgets::WFSConnector::create(std::list<DataSourcePtr>& datasources)
{
...
void te::qt::widgets::WFSConnector::update(std::list<DataSourcePtr>& /*datasources*/)
{
...
void te::qt::widgets::WFSConnector::remove(std::list<DataSourcePtr>& /*datasources*/)
{
  QMessageBox::warning(this,
                       tr("TerraLib Qt Components"),
                       tr("Not implemented yet!\nWe will provide it soon!"));
