...
/*!
  \file terralib/layout/qt/core/pattern/factory/outside/PropertiesOutsideFactory.h

  \brief This is the concrete factory for color dialog outside.
 */

#ifndef __TERRALIB_LAYOUT_INTERNAL_PROPERTIES_OUTSIDE_OUTSIDE_FACTORY_H
#define __TERRALIB_LAYOUT_INTERNAL_PROPERTIES_OUTSIDE_OUTSIDE_FACTORY_H
...
namespace te
{
  namespace layout
  {
    ...
    /*!
      \class PropertiesOutsideFactory

      \brief This is the concrete factory for color dialog outside.

      \sa NewOutsideFactory, ParameterizedAbstractFactory, AbstractOutsideView
    */
    class TELAYOUTEXPORT PropertiesOutsideFactory : public NewOutsideFactory
    {
      public:

        /*! It register the factory in the abstract dictionary. */
        PropertiesOutsideFactory();
