...
/*!
  \file QVerticalRulerLayoutItem.h
...
#ifndef __TERRALIB_LAYOUT_INTERNAL_QVERTICALRULER_LAYOUTITEM_H 
#define __TERRALIB_LAYOUT_INTERNAL_QVERTICALRULER_LAYOUTITEM_H
