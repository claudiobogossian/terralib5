...
/*!
  \file terralib/qt/plugins/processing/VectorToRasterAction.cpp

  \brief This file defines the VectorToRaster class
*/

// Terralib
#include "../../../processing/qt/VectorToRasterDialog.h"
...
te::qt::plugins::processing::VectorToRasterAction::VectorToRasterAction(QMenu* menu)
  : te::qt::plugins::processing::AbstractAction(menu)
{
  createAction(tr("VectorToRaster...").toStdString(), "processing-vector-to-raster");
}

te::qt::plugins::processing::VectorToRasterAction::~VectorToRasterAction()
{
}

void te::qt::plugins::processing::VectorToRasterAction::onActionActivated(bool checked)
{
  QWidget* parent = te::qt::af::ApplicationController::getInstance().getMainWindow();
  te::processing::VectorToRasterDialog dlg(parent);
