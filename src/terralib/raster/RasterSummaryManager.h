    ...
    */
    class TERASTEREXPORT RasterSummaryManager : public te::common::Singleton<RasterSummaryManager>
    {
      ...
      public:
        ...
        */
        void add(Raster* raster, RasterSummary* summary);
        ...
        */
        const RasterSummary* find(Raster* raster) const;
        ...
        */
        const RasterSummary* get(Raster* raster, const SummaryTypes st);
      ...
      private:
        ...
        boost::ptr_map<Raster*, RasterSummary> m_rasterSummaries;    //!< A map of rasters and their respective summaries.
    };
