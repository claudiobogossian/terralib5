...
te::layout::DisplayWindowLayoutModel::DisplayWindowLayoutModel()
{
...
void te::layout::DisplayWindowLayoutModel::updateObserver( ContextLayoutItem context )
{
...
void te::layout::DisplayWindowLayoutModel::setPosition( const double& x, const double& y )
{
  double x1 = x; 
