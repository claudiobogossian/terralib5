...
te::qt::widgets::SHP2PostGISDialog::SHP2PostGISDialog(QWidget* parent, Qt::WindowFlags f)
  : QDialog(parent, f),
    m_ui(new Ui::SHP2PostGisDialogForm)
{
// setup widget
  m_ui->setupUi(this);

// add icons
  m_ui->m_imgLabel->setPixmap(QIcon::fromTheme("data-exchange-shp-pgis-hint").pixmap(112,48));
...
void te::qt::widgets::SHP2PostGISDialog::setDataSources()
{
  ...
  te::da::DataSourceInfoManager::getInstance().getByType("POSTGIS", datasources); // TENSO
