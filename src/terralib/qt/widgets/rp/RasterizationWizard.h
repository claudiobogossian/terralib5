...
#ifndef TE_QT_WIDGETS_RASTERIZATIONWIZARD_H
#define TE_QT_WIDGETS_RASTERIZATIONWIZARD_H
...
namespace te 
{
  ...
  namespace qt 
  {
    namespace widgets 
    {
      ...
      class TEQTWIDGETSEXPORT RasterizationWizard : public QWizard
      {
        public:
...
#endif // TE_QT_WIDGETS_RASTERIZATIONWIZARD_H
