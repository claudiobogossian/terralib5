...
/*!
  \file terralib/dataaccess/memory/ExpansibleBandBlocksManager.h
 
  \brief RAM cached and tiled raster band blocks manager.
*/

#ifndef __TERRALIB_DATAACCESS_MEMORY_INTERNAL_EXPANSIBLEBANDBLOCKSMANAGER_H
#define __TERRALIB_DATAACCESS_MEMORY_INTERNAL_EXPANSIBLEBANDBLOCKSMANAGER_H
...
#endif  // __TERRALIB_DATAACCESS_MEMORY_INTERNAL_EXPANSIBLEBANDBLOCKSMANAGER_H
