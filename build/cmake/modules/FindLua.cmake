...
if(UNIX)
  ...
  find_library(LUA_LIBRARY_DEBUG
               NAMES luad lua_d lua51d lua51_d lua5.1d lua5.1_d lua-5.1d lua-5.1_d
               HINTS
                 ENV LUA_DIR
               PATH_SUFFIXES lib)
  ...
  elseif(LUA_LIBRARY_RELEASE)
    set(LUA_LIBRARY optimized ${LUA_LIBRARY_RELEASE} debug ${LUA_LIBRARY_RELEASE})
  elseif(LUA_LIBRARY_DEBUG)
    set(LUA_LIBRARY optimized ${LUA_LIBRARY_DEBUG} debug ${LUA_LIBRARY_DEBUG})
  endif()
endif()
