...
/*!
  \file terralib/layout/qt/core/pattern/factory/GridGeodesicItemFactory.h

  \brief This is the concrete factory for grid geodesic item.
 */

#ifndef __TERRALIB_LAYOUT_INTERNAL_GRIDGEODESIC_ITEM_FACTORY_H
#define __TERRALIB_LAYOUT_INTERNAL_GRIDGEODESIC_ITEM_FACTORY_H
...
namespace te
{
  namespace layout
  {
    ...
    /*!
      \class GridGeodesicItemFactory

      \brief This is the concrete factory for grid geodesic item.

      \sa NewItemFactory, ParameterizedAbstractFactory, AbstractItemView
    */
    class TELAYOUTEXPORT GridGeodesicItemFactory : public NewItemFactory
    {
      public:

        /*! It register the factory in the abstract dictionary. */
        GridGeodesicItemFactory();
