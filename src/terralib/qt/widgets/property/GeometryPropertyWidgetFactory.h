...
#ifndef __TERRALIB_QT_WIDGETS_PROPERTY_INTERNAL_GEOMETRYPROPERTYWIDGETFACTORY_H
#define __TERRALIB_QT_WIDGETS_PROPERTY_INTERNAL_GEOMETRYPROPERTYWIDGETFACTORY_H
...
namespace te
{
  ...
  {   
    namespace widgets
    {
      ...
      */
      class TEQTWIDGETSEXPORT GeometryPropertyWidgetFactory : public te::qt::widgets::SimplePropertyWidgetFactory
      {
        public:
...
#endif // __TERRALIB_QT_WIDGETS_PROPERTY_INTERNAL_GEOMETRYPROPERTYWIDGETFACTORY_H