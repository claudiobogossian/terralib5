...
/*!
  \file LayoutAbstractTemplateFactory.h
...
namespace te
{
  namespace layout
  {
    ...
    {
      public:
        virtual ~LayoutAbstractTemplateFactory(void) {}
        virtual LayoutTemplate* make(LayoutTemplateType type, LayoutTemplateParamsCreate params = LayoutTemplateParamsCreate()) = 0;
      };
  }
}
