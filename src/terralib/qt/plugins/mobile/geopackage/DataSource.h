...
#ifndef __TERRALIB_GPKG_INTERNAL_DATASOURCE_H
#define __TERRALIB_GPKG_INTERNAL_DATASOURCE_H
...
namespace te
{
  namespace gpkg
  {
    ...
    */
    class TERRAMOBILEPLUGINSDLLEXPORT DataSource : public te::da::DataSource
    {
      public:
...
#endif  // __TERRALIB_GPKG_INTERNAL_DATASOURCE_H
