...
te::qt::widgets::PostGISConnector::PostGISConnector(QWidget* parent, Qt::WindowFlags f)
  : AbstractDataSourceConnector(parent, f)
{
}

te::qt::widgets::PostGISConnector::~PostGISConnector()
{
}

void te::qt::widgets::PostGISConnector::create(std::list<DataSourcePtr>& datasources)
{
...
void te::qt::widgets::PostGISConnector::update(std::list<DataSourcePtr>& datasources)
{
...
void te::qt::widgets::PostGISConnector::remove(std::list<DataSourcePtr>& datasources)
{
  for(std::list<DataSourcePtr>::iterator it = datasources.begin(); it != datasources.end(); ++it)
  {
    if(it->get() == 0)
