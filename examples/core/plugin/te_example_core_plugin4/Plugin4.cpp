...
/*!
  \file terralib/examples/core/plugin/terralib_example_core_plugin4/Plugin4.cpp
...
TERRALIB_CPP_PLUGIN_BEGIN(Plugin4)
...
TERRALIB_CPP_PLUGIN_STARTUP
{
  ...
  std::cout << "Plugin4 startup" << std::endl;
...
{
  std::cout << "Plugin4 shutdown" << std::endl;
  
  m_initialized = false;
}

TERRALIB_CPP_PLUGIN_END(Plugin4)
