                                                              ...
                                                              CellSpaceType type)
{
  ...
  {
    te::rst::Grid* grid = new te::rst::Grid(maxcols, maxlines, resX, resY, &newEnv, srid);
    ...
    m_outputRaster = te::rst::RasterFactory::make("MEM", grid, bprops, std::map<std::string, std::string>());
