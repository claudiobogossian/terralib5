...
/*!
  \file terralib/dataaccess/memory/Raster.h

  \brief A raster class for memory.
*/

#ifndef __TERRALIB_DATAACCESS_MEMORY_INTERNAL_RASTER_H
#define __TERRALIB_DATAACCESS_MEMORY_INTERNAL_RASTER_H
...
#endif //__TERRALIB_DATAACCESS_MEMORY_INTERNAL_RASTER_H
