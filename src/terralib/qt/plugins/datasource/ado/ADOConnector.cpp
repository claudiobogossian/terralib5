...
/*!
  \file terralib/qt/widgets/datasource/connector/ado/ADOConnector.cpp
...
te::qt::plugins::ado::ADOConnector::~ADOConnector()
{
}

void te::qt::plugins::ado::ADOConnector::connect(std::list<te::da::DataSourceInfoPtr>& datasources)
{
...
void te::qt::plugins::ado::ADOConnector::create(std::list<te::da::DataSourceInfoPtr>& datasources)
{
  std::auto_ptr<ADOCreatorDialog> cdialog(new ADOCreatorDialog(static_cast<QWidget*>(parent())));
...
void te::qt::plugins::ado::ADOConnector::remove(std::list<te::da::DataSourceInfoPtr>& datasources)
{
  for(std::list<te::da::DataSourceInfoPtr>::iterator it = datasources.begin(); it != datasources.end(); ++it)
  {
    if(it->get() == 0)
