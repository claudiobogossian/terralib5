...
/*!
  \file terralib/qt/plugins/attributefill/AbstractAction.h

  \brief This file defines the abstract class AbstractAction
*/

#ifndef __TE_QT_PLUGINS_ATTRIBUTEFILL_INTERNAL_ABSTRACTACTION_H
#define __TE_QT_PLUGINS_ATTRIBUTEFILL_INTERNAL_ABSTRACTACTION_H
    ...
    namespace plugins
    {
      namespace attributefill
      {
        /*!
          ...
          \brief This is an abstract class used to register actions into Attribute Fill pluging.
...
#endif //__TE_QT_PLUGINS_ATTRIBUTEFILL_INTERNAL_ABSTRACTACTION_H