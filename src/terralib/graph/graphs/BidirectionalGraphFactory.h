...
/*!
  \file BidirectionalGraphFactory.h

  \brief This is the concrete factory for the bidirectional Graph type.
*/

#ifndef __TERRALIB_GRAPH_INTERNAL_BIDIRECTIONALGRAPHFACTORY_H
#define __TERRALIB_GRAPH_INTERNAL_BIDIRECTIONALGRAPHFACTORY_H
...
namespace te
{
  ...
  {
    /*!
      \class BidirectionGraphFactory

      \brief This is the concrete factory for the bidirectional Graph type.

      \sa te::graph::AbstractGraphFactory
    */
    class TEGRAPHEXPORT BidirectionalGraphFactory : public te::graph::AbstractGraphFactory
    {
      public:
      ...
      private:
        ...
        static BidirectionalGraphFactory* sm_factory; //!< Static instance used to register the factory
...
#endif  // __TERRALIB_GRAPH_INTERNAL_BIDIRECTIONALGRAPHFACTORY_H
