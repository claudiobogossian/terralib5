...
/*!
  \file terralib/rp/TiePointsLocatorStrategyParameters.cpp
...
namespace te
{
  namespace rp
  {
    TiePointsLocatorStrategyParameters::TiePointsLocatorStrategyParameters()
    {
      reset();
    }
    
    TiePointsLocatorStrategyParameters::TiePointsLocatorStrategyParameters( const TiePointsLocatorStrategyParameters& other )
    {
      reset();
      operator=( other );
    }    
    ...
    void TiePointsLocatorStrategyParameters::reset() throw( te::rp::Exception )
    {
      m_interesPointsLocationStrategy = TiePointsLocatorStrategyParameters::SurfStrategyT;
      m_inRaster1Ptr = 0;
    ...
    const TiePointsLocatorStrategyParameters& TiePointsLocatorStrategyParameters::operator=(
      const TiePointsLocatorStrategyParameters& params )
    {
      reset();
    ...
    te::common::AbstractParameters* TiePointsLocatorStrategyParameters::clone() const
    {
      return new TiePointsLocatorStrategyParameters( *this );
    }
