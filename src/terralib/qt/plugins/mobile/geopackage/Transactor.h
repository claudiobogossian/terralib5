...
#ifndef __TERRALIB_GPKG_INTERNAL_TRANSACTOR_H
#define __TERRALIB_GPKG_INTERNAL_TRANSACTOR_H
...
namespace te
{
  ...
  namespace gpkg
  {
    ...
    class TERRAMOBILEPLUGINSDLLEXPORT Transactor : public te::da::DataSourceTransactor
    {
      public:
...
#endif //__TERRALIB_GPKG_INTERNAL_TRANSACTOR_H
