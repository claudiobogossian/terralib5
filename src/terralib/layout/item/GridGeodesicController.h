...
#ifndef __TERRALIB_LAYOUT_INTERNAL_GRIDGEODESIC_CONTROLLER_H 
#define __TERRALIB_LAYOUT_INTERNAL_GRIDGEODESIC_CONTROLLER_H
  ...
  namespace layout
  {
    ...
    class TELAYOUTEXPORT GridGeodesicController : public GridMapController
    {
      public:
        ...
        */
        GridGeodesicController( Observable* o );
