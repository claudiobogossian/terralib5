...
/*!
  \file terralib/dataaccess/core/dataset/DataSetCapabilities.h

  \brief A class that informs what the dataset implementation of a given data source can perform.
*/

#ifndef __TERRALIB_DATAACCESS_CORE_DATASET_INTERNAL_DATASETCAPABILITIES_H
...
#endif  // __TERRALIB_DATAACCESS_CORE_DATASET_INTERNAL_DATASETCAPABILITIES_H
