...
/*!
  \file terralib/dataaccess/memory/CachedBandBlocksManager.h
 
  \brief RAM cached and tiled raster band blocks manager.
*/

#ifndef __TERRALIB_DATAACCESS_MEMORY_INTERNAL_CACHEDBANDBLOCKSMANAGER_H
#define __TERRALIB_DATAACCESS_MEMORY_INTERNAL_CACHEDBANDBLOCKSMANAGER_H
...
#endif  // __TERRALIB_DATAACCESS_MEMORY_INTERNAL_CACHEDBANDBLOCKSMANAGER_H
