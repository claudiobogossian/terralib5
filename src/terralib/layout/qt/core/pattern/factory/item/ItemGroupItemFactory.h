...
/*!
  \file terralib/layout/qt/core/pattern/factory/ItemGroupItemFactory.h

  \brief This is the concrete factory for item group item.
 */

#ifndef __TERRALIB_LAYOUT_INTERNAL_ITEM_GROUP_ITEM_FACTORY_H
#define __TERRALIB_LAYOUT_INTERNAL_ITEM_GROUP_ITEM_FACTORY_H
...
namespace te
{
  namespace layout
  {
    ...
    */
    class TELAYOUTEXPORT ItemGroupItemFactory : public NewItemFactory
    {
      public:

        /*! It register the factory in the abstract dictionary. */
        ItemGroupItemFactory();
