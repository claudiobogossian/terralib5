...
/*!
  \file terralib/ws/ogc/wms/qt/WMSLayerSelector.h

  \brief A simple widget that allows the selection of datasets from a given WMS server.
*/

#ifndef __TERRALIB_WS_OGC_WMS_QT_WMSLAYERSELECTOR_H
#define __TERRALIB_WS_OGC_WMS_QT_WMSLAYERSELECTOR_H
      ...
      namespace wms
      {
        namespace qt
        {
          /*!
            ...
            \brief A simple widget that allows the selection of datasets from a given WMS server.
          */
          class TEOGCWMSQTEXPORT WMSLayerSelector : public te::qt::widgets::AbstractLayerSelector
          {
            public:
...
#endif // __TERRALIB_WS_OGC_WMS_QT_WMSLAYERSELECTOR_H
