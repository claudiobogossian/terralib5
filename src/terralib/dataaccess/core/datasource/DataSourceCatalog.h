...
/*!
  \file terralib/dataaccess/core/datasource/DataSourceCatalog.h

  \brief It represents the system catalog of a DataSource.
*/

#ifndef __TERRALIB_DATAACCESS_CORE_INTERNAL_DATASOURCECATALOG_H
#define __TERRALIB_DATAACCESS_CORE_INTERNAL_DATASOURCECATALOG_H
...
#endif  // __TERRALIB_DATAACCESS_CORE_INTERNAL_DATASOURCECATALOG_H
