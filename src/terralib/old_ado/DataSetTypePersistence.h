...
#ifndef __TERRALIB_ADO_INTERNAL_DATASETTYPEPERSISTENCE_H
#define __TERRALIB_ADO_INTERNAL_DATASETTYPEPERSISTENCE_H
...
// Forward declaration
    ...
    */
    class TEADOEXPORT DataSetTypePersistence : public te::da::DataSetTypePersistence
    {
      public:
        ...
        void create(te::da::DataSetType* dt, const std::map<std::string, std::string>& options = std::map<std::string, std::string>());
...
#endif  // __TERRALIB_ADO_INTERNAL_DATASETTYPEPERSISTENCE_H
