...
/*!
  \file terralib/dataaccess/core/query/SQLVisitor.h

  \brief A visitor for building an SQL statement from a given Query hierarchy.
*/

#ifndef __TERRALIB_DATAACCESS_CORE_QUERY_INTERNAL_SQLVISITOR_H
#define __TERRALIB_DATAACCESS_CORE_QUERY_INTERNAL_SQLVISITOR_H
...
#endif  // __TERRALIB_DATAACCESS_CORE_QUERY_INTERNAL_SQLVISITOR_H
