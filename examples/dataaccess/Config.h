...
/*!
  ...
  \brief Global configuration flags for the TerraLib DataAccess Examples.
 */

#ifndef __TERRALIB_EXAMPLES_DATAACCESS_INTERNAL_CONFIG_H
#define __TERRALIB_EXAMPLES_DATAACCESS_INTERNAL_CONFIG_H
...
/*!
  ...
  \brief Flags for TerraLib DataAccess Examples.
...
#if TE_USE_MYSQL
#define TE_EXAMPLE_USE_MYSQL 1
#endif

#if TE_USE_SQLITE
#define TE_EXAMPLE_USE_SQLITE 1
#endif

#endif  // __TERRALIB_EXAMPLES_DATAACCESS_INTERNAL_CONFIG_H
