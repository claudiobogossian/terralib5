...
/*!
  \file VerticalRulerLayoutController.h
...
#ifndef __TERRALIB_LAYOUT_INTERNAL_VERTICALRULER_LAYOUTCONTROLLER_H
#define __TERRALIB_LAYOUT_INTERNAL_VERTICALRULER_LAYOUTCONTROLLER_H
