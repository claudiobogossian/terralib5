...
#ifndef __TERRALIB_LAYOUT_INTERNAL_QPAPER_LAYOUTITEM_H
#define __TERRALIB_LAYOUT_INTERNAL_QPAPER_LAYOUTITEM_H
  ...
  namespace layout
  {
    ...
    class QPaperLayoutItem : public QObjectLayoutItem
    {
      public:
        ...
        QPaperLayoutItem( LayoutItemController* controller, LayoutObservable* o );
