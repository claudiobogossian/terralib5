...
#ifndef __TERRALIB_LAYOUT_INTERNAL_QOBJECT_LAYOUTITEM_H 
#define __TERRALIB_LAYOUT_INTERNAL_QOBJECT_LAYOUTITEM_H
  ...
  namespace layout
  {
    class QObjectLayoutItem : public QGraphicsObject, public LayoutItemObserver
    {
      ...
      public:
        ...
        QObjectLayoutItem(LayoutItemController* controller = 0, LayoutObservable* o = 0);
