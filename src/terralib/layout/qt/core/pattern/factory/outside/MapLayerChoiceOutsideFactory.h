...
#ifndef __TERRALIB_LAYOUT_INTERNAL_MAPLAYER_CHOICE_OUTSIDE_FACTORY_H
#define __TERRALIB_LAYOUT_INTERNAL_MAPLAYER_CHOICE_OUTSIDE_FACTORY_H
...
namespace te
{
  namespace layout
  {
    ...
    */
    class TELAYOUTEXPORT MapLayerChoiceOutsideFactory : public NewOutsideFactory
    {
      public:

        /*! It register the factory in the abstract dictionary. */
        MapLayerChoiceOutsideFactory();
