...
#ifndef __TE_QT_PLUGINS_LAYOUT2_INTERNAL_PLUGIN_H
#define __TE_QT_PLUGINS_LAYOUT2_INTERNAL_PLUGIN_H
      ...
      namespace layout2
      {
        ...
        class Plugin : public te::plugin::Plugin
        {
          ...
          protected:
            ...
            te::qt::plugins::layout2::LayoutEditorAction* m_layout;    //!< Layout Process Action
        };
...
PLUGIN_CALL_BACK_DECLARATION(TEQTPLUGINLAYOUT2EXPORT);

#endif //__TE_QT_PLUGINS_LAYOUT2_INTERNAL_PLUGIN_H
