...
// Print only fail results in a txt file (the same you can see in DOS window)  
  std::ofstream file1( TE_DATA_UNITTEST_LOCALE "/testsResult_geometry_dos.txt" );
...
// Print formated testResult in a txt 
  CPPUNIT_NS::OFileStream file3( TE_DATA_UNITTEST_LOCALE "/testsResult_geometry_formated.txt" );
