...
/*!
  \file terralib/qt/widgets/tools/PanMiddleClick.cpp
...
te::qt::widgets::PanMiddleClick::PanMiddleClick(te::qt::widgets::MapDisplay* display, QObject* parent)
  : AbstractTool(display, parent),
    m_panStarted(false)
{
}

te::qt::widgets::PanMiddleClick::~PanMiddleClick()
{
}

bool te::qt::widgets::PanMiddleClick::mousePressEvent(QMouseEvent* e)
{
  if(e->button() != Qt::MiddleButton)
    return false;

  m_currentCursor = m_display->cursor();
...
bool te::qt::widgets::PanMiddleClick::mouseMoveEvent(QMouseEvent* e)
{
  if(!m_panStarted)
    return false;
...
bool te::qt::widgets::PanMiddleClick::mouseReleaseEvent(QMouseEvent* e)
{
  m_panStarted = false;

  // Roll back the default tool cursor
  m_display->setCursor(m_currentCursor);
