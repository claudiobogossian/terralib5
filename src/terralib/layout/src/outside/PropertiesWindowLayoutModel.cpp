...
te::layout::PropertiesWindowLayoutModel::PropertiesWindowLayoutModel()
{
...
void te::layout::PropertiesWindowLayoutModel::updateObserver( ContextLayoutItem context )
{
...
void te::layout::PropertiesWindowLayoutModel::setPosition( const double& x, const double& y )
{
  double x1 = x; 
