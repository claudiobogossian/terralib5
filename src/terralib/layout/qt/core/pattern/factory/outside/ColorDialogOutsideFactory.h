...
#ifndef __TERRALIB_LAYOUT_INTERNAL_COLOR_DIALOG_OUTSIDE_FACTORY_H
#define __TERRALIB_LAYOUT_INTERNAL_COLOR_DIALOG_OUTSIDE_FACTORY_H
...
namespace te
{
  namespace layout
  {
    ...
    */
    class TELAYOUTEXPORT ColorDialogOutsideFactory : public NewOutsideFactory
    {
      public:

        /*! It register the factory in the abstract dictionary. */
        ColorDialogOutsideFactory();
