...
/*!
  \file terralib/qt/widgets/se/BasicFillWidgetFactory.h

  \brief A concrete factory that builds a fill widget used to configure a basic fill element.
*/

#ifndef __TERRALIB_QT_SE_INTERNAL_BASICFILLWIDGETFACTORY_H
#define __TERRALIB_QT_SE_INTERNAL_BASICFILLWIDGETFACTORY_H
...
namespace te
{
  namespace qt
  {
    namespace widgets
    {
      ...
      */
      class TEQTWIDGETSEXPORT BasicFillWidgetFactory : public AbstractFillWidgetFactory
      {
        public:
        ...
        private:
          ...
          static BasicFillWidgetFactory* sm_factory; //!< A pointer to the global factory.
      };
...
#endif  // __TERRALIB_QT_SE_INTERNAL_BASICFILLWIDGETFACTORY_H
