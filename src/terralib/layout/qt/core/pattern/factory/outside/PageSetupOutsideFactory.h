...
#ifndef __TERRALIB_LAYOUT_INTERNAL_PAGE_SETUP_OUTSIDE_FACTORY_H
#define __TERRALIB_LAYOUT_INTERNAL_PAGE_SETUP_OUTSIDE_FACTORY_H
...
namespace te
{
  namespace layout
  {
    ...
    */
    class TELAYOUTEXPORT PageSetupOutsideFactory : public NewOutsideFactory
    {
      public:

        /*! It register the factory in the abstract dictionary. */
        PageSetupOutsideFactory();
