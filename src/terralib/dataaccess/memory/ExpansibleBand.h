...
/*!
  \file terralib/dataaccess/memory/ExpansibleBand.h
 
  \brief Expansible raster band.
*/

#ifndef __TERRALIB_DATAACCESS_MEMORY_INTERNAL_EXPANSIBLEBAND_H
#define __TERRALIB_DATAACCESS_MEMORY_INTERNAL_EXPANSIBLEBAND_H
...
#endif  // __TERRALIB_DATAACCESS_MEMORY_INTERNAL_EXPANSIBLEBAND_H
