...
#ifndef __TERRALIB_LAYOUT_INTERNAL_ELLIPSE_CONTROLLER_H 
#define __TERRALIB_LAYOUT_INTERNAL_ELLIPSE_CONTROLLER_H
...
namespace te
{
  namespace layout
  {
    /*!
	  ...
	  */
    class TELAYOUTEXPORT EllipseController : public ItemController
    {
      public:
