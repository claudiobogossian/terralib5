...
/*!
  \file terralib/layout/qt/core/pattern/factory/LegendItemFactory.h

  \brief This is the concrete factory for legend item.
 */

#ifndef __TERRALIB_LAYOUT_INTERNAL_LEGEND_ITEM_FACTORY_H
#define __TERRALIB_LAYOUT_INTERNAL_LEGEND_ITEM_FACTORY_H
...
namespace te
{
  namespace layout
  {
    ...
    */
    class TELAYOUTEXPORT LegendItemFactory : public NewItemFactory
    {
      public:
