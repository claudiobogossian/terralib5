...
/*!
  \file terralib/dataaccess/query/GreaterThan.h

  \brief It models the inequality operator greater than (>) - syntatic-suggar.
*/

#ifndef __TERRALIB_DATAACCESS_INTERNAL_GREATERTHAN_H
#define __TERRALIB_DATAACCESS_INTERNAL_GREATERTHAN_H
...
#endif  // __TERRALIB_DATAACCESS_INTERNAL_GREATERTHAN_H
