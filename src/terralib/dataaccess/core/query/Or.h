...
/*!
  \file terralib/dataaccess/core/query/Or.h

  \brief Boolean logic operator: OR - syntatic-suggar.
*/

#ifndef __TERRALIB_DATAACCESS_CORE_QUERY_INTERNAL_OR_H
#define __TERRALIB_DATAACCESS_CORE_QUERY_INTERNAL_OR_H
...
#endif  // __TERRALIB_DATAACCESS_CORE_QUERY_INTERNAL_OR_H
