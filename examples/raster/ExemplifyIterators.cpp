...
// define raster mask and load
  ...
  minfo["URI"] = TERRALIB_DATA_DIR "/geotiff/cbers2b_rgb342_crop_mask_1bit.tif";
...
// define output raster and create (only one band will be created)
  ...
  orinfo["URI"] = TERRALIB_DATA_DIR "/geotiff/cbers2b_rgb342_crop_mask_8bits.tif";
...
// define output raster info
  std::map<std::string, std::string> orinfo;
  orinfo["URI"] = TERRALIB_DATA_DIR "/geotiff/cbers2b_band3_crop_median_5x5.tif";
