...
/*!
  \file terralib/dataaccess/core/query/FunctionDefn.h

  \brief The definition of a function that can be used in a query object.
*/

#ifndef __TERRALIB_DATAACCESS_CORE_QUERY_INTERNAL_FUNCTIONDEFN_H
#define __TERRALIB_DATAACCESS_CORE_QUERY_INTERNAL_FUNCTIONDEFN_H
...
#endif  // __TERRALIB_DATAACCESS_CORE_QUERY_INTERNAL_FUNCTIONDEFN_H
