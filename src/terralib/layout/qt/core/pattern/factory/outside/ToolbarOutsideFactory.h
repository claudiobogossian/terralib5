...
#ifndef __TERRALIB_LAYOUT_INTERNAL_TOOLBAR_OUTSIDE_FACTORY_H
#define __TERRALIB_LAYOUT_INTERNAL_TOOLBAR_OUTSIDE_FACTORY_H
...
namespace te
{
  namespace layout
  {
    ...
    */
    class TELAYOUTEXPORT ToolbarOutsideFactory : public NewOutsideFactory
    {
      public:

        /*! It register the factory in the abstract dictionary. */
        ToolbarOutsideFactory();
