...
//std::map<std::string, std::string> te::mysql::DataSource::sm_capabilities;
...
void te::mysql::DataSource::getCapabilities(std::map<std::string, std::string>& capabilities) const
{
  //if(m_isrw)
