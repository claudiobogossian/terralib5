...
/*!
  \file terralib/processing/Module.h
   
  \brief This singleton defines the TerraLib Processing module entry.
*/

#ifndef __TERRALIB_PROCESSING_INTERNAL_MODULE_H
#define __TERRALIB_PROCESSING_INTERNAL_MODULE_H
    ...
    */
    class Module : public te::common::Singleton<Module>
    {
      ...
      private:
        ...
        /*!
          \brief This is the startup function for the TerraLib Processing module.
        ...
        */
        ...
        /*!
          \brief This is the cleanup function for the TerraLib Processing module.
...
#endif  // __TERRALIB_PROCESSING_INTERNAL_MODULE_H
