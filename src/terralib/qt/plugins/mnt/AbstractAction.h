...
/*!
  \file terralib/qt/plugins/mnt/AbstractAction.h

  \brief This file defines the abstract class AbstractAction
*/

#ifndef __TE_QT_PLUGINS_MNT_INTERNAL_ABSTRACTACTION_H
#define __TE_QT_PLUGINS_MNT_INTERNAL_ABSTRACTACTION_H
    ...
    namespace plugins
    {
      namespace mnt
      {
        /*!
          ...
          \brief This is an abstract class used to register actions into mnt pluging.
...
#endif //__TE_QT_PLUGINS_MNT_INTERNAL_ABSTRACTACTION_H