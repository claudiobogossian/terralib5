    ...
    */
    class TESTEXPORT ObservationDataSetInfo
    {
      public:
        ...
        */
        ObservationDataSetInfo(const te::da::DataSourceInfo& dsInfo, 
        ...
        */
        ...
        /*!
          \brief It sets the information about the DataSource and the DataSet name that contains the observations
        ...
        */
        ...
        /*!
          ...
          \param tpInfo The property info that contains the phenomenon time.
