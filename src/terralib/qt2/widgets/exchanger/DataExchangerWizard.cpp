...
#include "../../../dataaccess2/dataset/DataSetAdapter.h"
#include "../../../dataaccess2/dataset/DataSetType.h"
#include "../../../dataaccess2/dataset/DataSetTypeConverter.h"
...
#include "../../../qt2/widgets/dataset/selector/DataSetSelectorWizardPage.h"
#include "../../../qt2/widgets/datasource/selector/DataSourceSelectorWidget.h"
#include "../../../qt2/widgets/datasource/selector/DataSourceSelectorWizardPage.h"
#include "../../../qt2/widgets/utils/ScopedCursor.h"
...
// get input data source
  ...
  te::da::DataSourcePtr idatasource;
  // Datasource manager
  //te::da::DataSourceManager::getInstance().get(ids->getId(), ids->getAccessDriver(), ids->getConnInfo());
...
// get output data source
  ...
  // Datasource manager
  //= te::da::DataSourceManager::getInstance().get(ods->getId(), ods->getAccessDriver(), ods->getConnInfo());
