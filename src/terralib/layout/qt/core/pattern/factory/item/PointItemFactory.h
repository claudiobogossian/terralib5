...
/*!
  \file terralib/layout/qt/core/pattern/factory/PointItemFactory.h

  \brief This is the concrete factory for point item.
 */

#ifndef __TERRALIB_LAYOUT_INTERNAL_POINT_ITEM_FACTORY_H
#define __TERRALIB_LAYOUT_INTERNAL_POINT_ITEM_FACTORY_H
...
namespace te
{
  namespace layout
  {
    ...
    */
    class TELAYOUTEXPORT PointItemFactory : public NewItemFactory
    {
      public:
