...
#ifndef __TERRALIB_GRAPH_INTERNAL_DIRECTEDGRAPHFACTORY_H
#define __TERRALIB_GRAPH_INTERNAL_DIRECTEDGRAPHFACTORY_H
...
namespace te
{
  namespace graph
  {
    ...
    */
    class TEGRAPHEXPORT DirectedGraphFactory : public te::graph::AbstractGraphFactory
    {
      public:
      ...
      private:
        ...
        static DirectedGraphFactory* sm_factory;  //!< Static instance used to register the factory
...
#endif  // __TERRALIB_GRAPH_INTERNAL_DIRECTEDGRAPHFACTORY_H
