...
/*!
  \file terralib/mongodb/FwDataSet.h

  \brief A forward-only dataset implementation for MongoDB.
*/

#ifndef __TERRALIB_MONGODB_INTERNAL_DATASET_H
#define __TERRALIB_MONGODB_INTERNAL_DATASET_H
...
// Forward declaration
namespace mongo { class DBClientCursor; }
...
namespace te
{
  namespace mongodb
  {
    /*!
      ...
      \sa te::da::DataSet
    */
    class TEMONGODBEXPORT FwDataSet : public te::da::DataSet
    {
      public:

        /*! \brief Default constructor. */
        FwDataSet(mongo::DBClientCursor* cursor);
...
#endif  // __TERRALIB_MONGODB_INTERNAL_DATASET_H
