...
#include "../dataaccess2/query/EqualTo.h"
#include "../dataaccess2/query/Field.h"
#include "../dataaccess2/query/GreaterThanOrEqualTo.h"
#include "../dataaccess2/query/LessThanOrEqualTo.h"
#include "../dataaccess2/query/LiteralDouble.h"
#include "../dataaccess2/query/LiteralEnvelope.h"
#include "../dataaccess2/query/LiteralString.h"
...
// retrieve the associated data source
  te::da::DataSourcePtr ds = te::da::GetDataSource(dlayer->getDataSourceId());
...
// get dataset information
  ...
  if(dstype->hasGeom())
  {
    ...
    {
      drawGrouping(dlayer, ds.get(), canvas, ibbox, srid);
      return;
    }
...
// should I render this style?
    ...
    DrawGeometries(dstype.get(), ds.get(), canvas, ibbox, dlayer->getSRID(), srid, fts);
  }
...
// should I render this style?
    ...
    DrawRaster(dstype.get(), ds.get(), canvas, ibbox, dlayer->getSRID(), bbox, srid, cs);
  }
  else
  {
...
void te::map::DataSetLayerRenderer::drawGrouping(DataSetLayer* layer, te::da::DataSource* dsrc, Canvas* canvas, const te::gm::Envelope& bbox, int srid)
{
...
// get the dataset type. TODO: Can we pass the datat set type as method parameter?
  std::auto_ptr<te::da::DataSetType> dataSetType = dsrc->getDataSetType(dsname);
