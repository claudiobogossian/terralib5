...
// find fisrt plugin manifest file, read the manifest, load plugin and start it
  std::string p1_manifest_file = te::core::FindInTerraLibPath("example/plugins/plugin1.teplg.json");
...
// find second plugin manifest file, read the manifest, load plugin and start it
  std::string p2_manifest_file = te::core::FindInTerraLibPath("example/plugins/plugin2.teplg.json");
