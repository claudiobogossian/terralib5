...
#ifdef TE_QT_PLUGIN_LAYOUT2_HAVE_LAYOUTEDITOR
...
te::qt::plugins::layout2::Plugin::~Plugin() 
{
}

void te::qt::plugins::layout2::Plugin::startup()
{
  if(m_initialized)
    return;
...
void te::qt::plugins::layout2::Plugin::shutdown()
{
  if(!m_initialized)
    return;
...
void te::qt::plugins::layout2::Plugin::registerActions()
{
#ifdef TE_QT_PLUGIN_LAYOUT2_HAVE_LAYOUTEDITOR
    m_layout = new te::qt::plugins::layout2::LayoutEditorAction(m_layoutMenu);
#endif
}

void  te::qt::plugins::layout2::Plugin::unRegisterActions()
{
#ifdef TE_QT_PLUGIN_LAYOUT2_HAVE_LAYOUTEDITOR
    delete m_layout;
#endif
...
PLUGIN_CALL_BACK_IMPL(te::qt::plugins::layout2::Plugin)
