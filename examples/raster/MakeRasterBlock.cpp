...
void MakeRasterBlock()
{
  try
  {
    ...
    irinfo["URI"] = ""TE_DATA_EXAMPLE_LOCALE"/data/rasters/cbers2b_rgb342_crop.tif";
...
// set envelope based on line/column 
    ...
    orinfo["URI"] = ""TE_DATA_EXAMPLE_LOCALE"/data/rasters/block_raster.tif";
  ...
  {
    std::cout << std::endl << "An exception has occurried in MakeRasterBlock(): " << e.what() << std::endl;
  }
  catch(...)
  {
    std::cout << std::endl << "An unexpected exception has occurried in MakeRasterBlock()!" << std::endl;
  }
