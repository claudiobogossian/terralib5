...
void ObjectId3()
{
  ...
  te::da::ObjectIdSet* oids = te::da::GenerateOIDSet(dataset, pk_name);
  ...
  te::da::DataSetType *dt1 =  cl->getDataSetType("public.br_munic_2001", true);
  te::da::ObjectIdSet* oids1 = te::da::GenerateOIDSet(dataset, dt1);
  te::da::DataSet* identified1 = transactor->getDataSet("public.br_munic_2001",oids1);

  
  std::cout << "== DataSet Retrieved From ObjectIdSet using dataSetType to discover pk == " << std::endl;
  PrintDataSet("munic_2001_identified",identified1);
...
// Another test: Not knowing primary key - do not use this way...all property names will be used in oids including geom  
  ...
  te::da::ObjectIdSet* oids2 = te::da::GenerateOIDSet(dataset, pnames);

  te::da::DataSet* identified2 = transactor->getDataSet("public.br_munic_2001",oids2);
