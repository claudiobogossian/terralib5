...
/*!
  \file terralib/dataaccess/core/query/Function.h

  \brief A class that models a Function expression.
*/

#ifndef __TERRALIB_DATAACCESS_CORE_QUERY_INTERNAL_FUNCTION_H
#define __TERRALIB_DATAACCESS_CORE_QUERY_INTERNAL_FUNCTION_H
...
#endif  // __TERRALIB_DATAACCESS_CORE_QUERY_INTERNAL_FUNCTION_H
