...
te::processing::VectorToRasterDialog::VectorToRasterDialog(QWidget* parent, Qt::WindowFlags f)
  : QDialog(parent, f),
...
te::processing::VectorToRasterDialog::~VectorToRasterDialog()
{
}

void te::processing::VectorToRasterDialog::setLayers(std::list<te::map::AbstractLayerPtr> layers)
{
  m_layers = layers;
...
te::map::AbstractLayerPtr te::processing::VectorToRasterDialog::getLayer()
{
  return m_outLayer;
}

std::vector<te::dt::Property*> te::processing::VectorToRasterDialog::getSelectedProperties()
{
...
void te::processing::VectorToRasterDialog::onVectorComboBoxChanged(int index)
{
  std::list<te::map::AbstractLayerPtr>::iterator it = m_layers.begin();
...
void te::processing::VectorToRasterDialog::onTargetDatasourceToolButtonPressed()
{
...
void te::processing::VectorToRasterDialog::onTargetFileToolButtonPressed()
{
  m_ui->m_newLayerNameLineEdit->clear();
  m_ui->m_repositoryLineEdit->clear();
  
  QString dir = QFileDialog::getExistingDirectory(this, tr("Open Directory"), te::qt::widgets::GetFilePathFromSettings("processing_vec2raster"), QFileDialog::ShowDirsOnly | QFileDialog::DontResolveSymlinks);
  ...
  if(dir.isEmpty() == false)
  {
    ...
    te::qt::widgets::AddFilePathToSettings(m_path.c_str(), "processing_vec2raster");

    m_toFile = true;
  }
}

void te::processing::VectorToRasterDialog::onHelpPushButtonClicked()
{
  QMessageBox::information(this, "Help", "Under development");
}

void te::processing::VectorToRasterDialog::onOkPushButtonClicked()
{
