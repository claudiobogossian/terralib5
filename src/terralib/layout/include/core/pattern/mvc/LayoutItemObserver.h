...
#ifndef __TERRALIB_LAYOUT_INTERNAL_LAYOUT_ITEM_OBSERVER_H 
#define __TERRALIB_LAYOUT_INTERNAL_LAYOUT_ITEM_OBSERVER_H
...
namespace te
{
  namespace layout
  {
    ...
    class LayoutItemObserver : LayoutObserver
    {
      public:
        LayoutItemObserver(LayoutItemController* controller = 0, LayoutObservable* o = 0);
        ...
        */
        ...
        virtual te::layout::LayoutProperties* getProperties() const;	
      ...
      protected:
        te::layout::LayoutItemController*	m_controller;
        te::layout::LayoutObservable*		m_model;
        double					m_ppi;
        bool            m_printable;
    };
  }
