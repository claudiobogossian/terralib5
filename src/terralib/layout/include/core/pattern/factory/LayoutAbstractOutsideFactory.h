...
/*!
  \file LayoutAbstractOutsideFactory.h
...
namespace te
{
  namespace layout
  {
    ...
    public:
      ...
      virtual LayoutObserver* make(LayoutAbstractObjectType type, LayoutOutsideParamsCreate params = LayoutOutsideParamsCreate()) = 0;
    };
  }
}
