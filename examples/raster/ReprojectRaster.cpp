...
void ReprojectRasterUsingDriver()
{
  try
  {
    ...
    // 1 - The entire image.
    rinfo["URI"] = ""TE_DATA_EXAMPLE_LOCALE"/data/rasters/cbers2b_rgb342_crop_LL.tif";
    ...
    // 2- To a given region.
    rinfo["URI"] = ""TE_DATA_EXAMPLE_LOCALE"/data/rasters/cbers2b_rgb342_crop_LL_P.tif";
    ...
    rinfo["URI"] = ""TE_DATA_EXAMPLE_LOCALE"/data/rasters/cbers2b_rgb342_crop_LL_PR.tif";
...
void ReprojectRasterUsingFunction()
{
  try
  {
    ...
    // 1 - The entire image.
    rinfo["URI"] = ""TE_DATA_EXAMPLE_LOCALE"/data/rasters/cbers2b_rgb342_crop_LL_ALG.tif";
    ...
    // 2- To a given region.
    rinfo["URI"] = ""TE_DATA_EXAMPLE_LOCALE"/data/rasters/cbers2b_rgb342_crop_LL_P_ALG.tif";
    ...
    // 3- To a given region and resolution.
    rinfo["URI"] = ""TE_DATA_EXAMPLE_LOCALE"/data/rasters/cbers2b_rgb342_crop_LL_PR_ALG.tif";
