...
te::layout::RectangleController::~RectangleController()
{
	
}

void te::layout::RectangleController::setPosition( const double& x, const double& y )
{
  if(m_model)
  {
...
void te::layout::RectangleController::create()
{
