...
/*!
  \file ObjectInspectorWindowLayoutModel.h
...
#ifndef __TERRALIB_LAYOUT_INTERNAL_OBJECTINSPECTOR_WINDOWLAYOUTMODEL_H
#define __TERRALIB_LAYOUT_INTERNAL_OBJECTINSPECTOR_WINDOWLAYOUTMODEL_H
