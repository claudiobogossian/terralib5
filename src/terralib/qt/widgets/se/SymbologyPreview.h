...
// Forward declaration
      ...
      class SymbologyPreview : public te::common::Static
      {
        public:
          ...
          */
          static QPixmap build(te::se::Symbolizer* symb, const QSize& size);
          ...
          */
          ...
          /*!
            ...
            \return A pixmap that represents the result of symbolizer preview.
          */
          static QPixmap build(te::se::Symbolizer* symb, te::gm::Geometry* geom, const QSize& size);
          ...
          /*!
            ...
            \return A pixmap that represents the composite result of symbolizers preview.
          */
          static QPixmap build(const std::vector<te::se::Symbolizer*>& symbs, te::gm::Geometry* geom, const QSize& size);
          ...
          */
          static QPixmap build(te::se::Rule* rule, te::gm::Geometry* geom, const QSize& size);
          ...
          */
          static QPixmap build(Symbol* symbol, te::gm::Geometry* geom, const QSize& size);
      };
