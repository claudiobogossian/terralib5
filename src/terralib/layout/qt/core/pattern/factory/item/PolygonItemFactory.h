...
/*!
  \file terralib/layout/qt/core/pattern/factory/PolygonItemFactory.h

  \brief This is the concrete factory for polygon item.
 */

#ifndef __TERRALIB_LAYOUT_INTERNAL_POLYGON_ITEM_FACTORY_H
#define __TERRALIB_LAYOUT_INTERNAL_POLYGON_ITEM_FACTORY_H
...
namespace te
{
  namespace layout
  {
    ...
    /*!
      \class PolygonItemFactory

      \brief This is the concrete factory for polygon item.

      \sa NewItemFactory, ParameterizedAbstractFactory, AbstractItemView
    */
    class TELAYOUTEXPORT PolygonItemFactory : public NewItemFactory
    {
      public:
