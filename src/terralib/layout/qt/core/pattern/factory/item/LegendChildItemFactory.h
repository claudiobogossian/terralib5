...
/*!
  \file terralib/layout/qt/core/pattern/factory/LegendChildItemFactory.h

  \brief This is the concrete factory for legend child item.
 */

#ifndef __TERRALIB_LAYOUT_INTERNAL_LEGEND_CHILD_ITEM_FACTORY_H
#define __TERRALIB_LAYOUT_INTERNAL_LEGEND_CHILD_ITEM_FACTORY_H
...
namespace te
{
  namespace layout
  {
    ...
    /*!
      \class LegendChildItemFactory

      \brief This is the concrete factory for legend child item.

      \sa NewItemFactory, ParameterizedAbstractFactory, AbstractItemView
    */
    class TELAYOUTEXPORT LegendChildItemFactory : public NewItemFactory
    {
      public:

        /*! It register the factory in the abstract dictionary. */
        LegendChildItemFactory();
