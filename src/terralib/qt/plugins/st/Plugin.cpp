...
te::qt::plugins::st::Plugin::Plugin(const te::core::PluginInfo& pluginInfo)
  : QObject(), te::core::CppPlugin(pluginInfo), m_stMenu(0), m_delegate(0)
{
}
...
TERRALIB_PLUGIN_CALL_BACK_IMPL(te::qt::plugins::st::Plugin)
