...
/*!
  \file terralib/dataaccess/memory/CachedRaster.h

  \brief A RAM cache adaptor to an external existent raster that must always be avaliable.
*/

#ifndef __TERRALIB_DATAACCESS_MEMORY_INTERNAL_CACHEDRASTER_H
#define __TERRALIB_DATAACCESS_MEMORY_INTERNAL_CACHEDRASTER_H
