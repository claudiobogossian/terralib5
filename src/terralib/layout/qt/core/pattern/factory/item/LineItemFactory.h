...
/*!
  \file terralib/layout/qt/core/pattern/factory/LineItemFactory.h

  \brief This is the concrete factory for line item.
 */

#ifndef __TERRALIB_LAYOUT_INTERNAL_LINE_ITEM_FACTORY_H
#define __TERRALIB_LAYOUT_INTERNAL_LINE_ITEM_FACTORY_H
...
namespace te
{
  namespace layout
  {
    ...
    */
    class TELAYOUTEXPORT LineItemFactory : public NewItemFactory
    {
      public:
