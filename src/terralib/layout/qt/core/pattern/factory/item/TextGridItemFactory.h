...
/*!
  \file terralib/layout/qt/core/pattern/factory/TextGridItemFactory.h

  \brief This is the concrete factory for text grid item.
 */

#ifndef __TERRALIB_LAYOUT_INTERNAL_TEXT_GRID_ITEM_FACTORY_H
#define __TERRALIB_LAYOUT_INTERNAL_TEXT_GRID_ITEM_FACTORY_H
...
namespace te
{
  namespace layout
  {
    ...
    /*!
      \class TextGridItemFactory

      \brief This is the concrete factory for text grid item.

      \sa NewItemFactory, ParameterizedAbstractFactory, AbstractItemView
    */
    class TELAYOUTEXPORT TextGridItemFactory : public NewItemFactory
    {
      public:
