...
#ifndef __TERRALIB_LAYOUT_INTERNAL_STAR_CONTROLLER_H 
#define __TERRALIB_LAYOUT_INTERNAL_STAR_CONTROLLER_H
...
namespace te
{
  namespace layout
  {
    ...
    /*!
	  ...
	  */
    class TELAYOUTEXPORT StarController : public ItemController
    {
      public:
        ...
        */
        StarController( Observable* o );

        /*!
          \brief Destructor
        */ 
        virtual ~StarController();
    };
  }
}
