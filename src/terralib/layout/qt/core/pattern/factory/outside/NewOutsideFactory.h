...
#ifndef __TERRALIB_LAYOUT_INTERNAL_NEW_OUTSIDE_FACTORY_H 
#define __TERRALIB_LAYOUT_INTERNAL_NEW_OUTSIDE_FACTORY_H
...
namespace te
{
  namespace layout
  {
    ...
    */
    class TELAYOUTEXPORT NewOutsideFactory : public te::common::ParameterizedAbstractFactory<AbstractOutsideView, std::string, OutsideFactoryParamsCreate>
    {
      public:

        /*! \brief Virtual destructor. */
        virtual ~NewOutsideFactory();
      ...
      protected:
        ...
        */
        NewOutsideFactory(const std::string& factoryKey);
