...
/*!
  \file terralib/qt/widgets/layer/explorer/ObservationLayerItem.cpp
...
te::qt::plugins::st::ObservationLayerItem::ObservationLayerItem(const te::map::AbstractLayerPtr& l, QObject* parent)
  : te::qt::widgets::AbstractTreeItem(parent)
{
  m_layer = boost::dynamic_pointer_cast<te::st::ObservationDataSetLayer>(l);
}

te::qt::plugins::st::ObservationLayerItem::~ObservationLayerItem()
{
}

int te::qt::plugins::st::ObservationLayerItem::columnCount() const
{
  return 1;
}
...
QMenu* te::qt::plugins::st::ObservationLayerItem::getMenu(QWidget* /*parent*/) const
{
  return 0;
}

bool te::qt::plugins::st::ObservationLayerItem::canFetchMore() const
{
  return (((m_layer->getStyle() != 0) && (!m_layer->getStyle()->getRules().empty())) || m_layer->getGrouping() != 0 || m_layer->getChart() != 0);
}

Qt::ItemFlags te::qt::plugins::st::ObservationLayerItem::flags() const
{
  return Qt::ItemIsUserCheckable | Qt::ItemIsDragEnabled | Qt::ItemIsDropEnabled;
}

void te::qt::plugins::st::ObservationLayerItem::fetchMore()
{
...
bool te::qt::plugins::st::ObservationLayerItem::hasChildren() const
{
  return ((m_layer->getStyle() != 0) && (!m_layer->getStyle()->getRules().empty())) || m_layer->getGrouping() != 0 || m_layer->getChart() != 0;
}

bool te::qt::plugins::st::ObservationLayerItem::setData(int column, const QVariant& value, int role)
{
  if(role == Qt::CheckStateRole)
  {
...
te::map::AbstractLayerPtr te::qt::plugins::st::ObservationLayerItem::getLayer() const
{
  return m_layer;
}

const std::string te::qt::plugins::st::ObservationLayerItem::getItemType() const
{
  return "Observation_LAYER_ITEM";
}

bool te::qt::plugins::st::ObservationLayerItem::hasGroupingItem() const
{
...
bool te::qt::plugins::st::ObservationLayerItem::hasChartItem() const
{
