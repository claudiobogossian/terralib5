...
// Forward declaration
    ...
    */
    void DrawGeometries(te::da::DataSetType* type, te::da::DataSource* dsrc, Canvas* canvas,
    ...
    */
    ...
    void DrawRaster(te::da::DataSetType* type, te::da::DataSource* dsrc, Canvas* canvas,
