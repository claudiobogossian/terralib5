...
te::qt::plugins::ogr::GeoFileDragAndDropHandler::GeoFileDragAndDropHandler() : m_isValid(false)
{
...
bool te::qt::plugins::ogr::GeoFileDragAndDropHandler::eventFilter(QObject* watched, QEvent* e)
{
  ...
  else if (e->type() == QEvent::Drop && m_isValid)
  {
    ...
    te::qt::plugins::ogr::CreateLayers(pathList);
