...
/*!
  \file terralib/layout/qt/core/pattern/factory/MapItemFactory.h

  \brief This is the concrete factory for map item.
 */

#ifndef __TERRALIB_LAYOUT_INTERNAL_MAP_ITEM_FACTORY_H
#define __TERRALIB_LAYOUT_INTERNAL_MAP_ITEM_FACTORY_H
...
namespace te
{
  namespace layout
  {
    ...
    */
    class TELAYOUTEXPORT MapItemFactory : public NewItemFactory
    {
      public:
