...
/*!
  \file src/terraMobilePlugin/AbstractAction.h

  \brief This file defines the abstract class AbstractAction
*/

#ifndef __TE_QT_PLUGINS_TERRAMOBILE_INTERNAL_ABSTRACTACTION_H
#define __TE_QT_PLUGINS_TERRAMOBILE_INTERNAL_ABSTRACTACTION_H
...
#endif //__TE_QT_PLUGINS_TERRAMOBILE_INTERNAL_ABSTRACTACTION_H