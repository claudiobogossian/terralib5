...
#ifndef __TERRALIB_FE_INTERNAL_MODULE_H
#define __TERRALIB_FE_INTERNAL_MODULE_H
  ...
  namespace fe
  {
    ...
    class Module : public te::common::Singleton<Module>
    {
      ...
      private:
        ...
        /*!
          \brief This is the startup function for the TerraLib Filter Encoding module.
        ...
        /*!
          \brief This is the cleanup function for the TerraLib Filter Encoding module.
...
#endif  // __TERRALIB_FE_INTERNAL_MODULE_H
