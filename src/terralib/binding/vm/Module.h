...
#ifndef __TERRALIB_BINDING_VM_INTERNAL_MODULE_H
#define __TERRALIB_BINDING_VM_INTERNAL_MODULE_H
    ...
    */
    class Module : public te::common::Singleton<Module>
    {
      ...
      private:
        ...
        /*!
          \brief This is the startup function for the TerraLib Lua Common Runtime module.
        ...
        /*!
          \brief This is the cleanup function for the TerraLib Lua Common Runtime module.
...
#endif  // __TERRALIB_BINDING_VM_INTERNAL_MODULE_H
