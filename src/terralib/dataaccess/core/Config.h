...
#ifndef __TERRALIB_DATAACCESS_CORE_INTERNAL_CONFIG_H
#define __TERRALIB_DATAACCESS_CORE_INTERNAL_CONFIG_H
...
*/
#define TE_DATAACCESS_MODULE_NAME "te.da.core"
...
#endif  // __TERRALIB_DATAACCESS_CORE_INTERNAL_CONFIG_H
