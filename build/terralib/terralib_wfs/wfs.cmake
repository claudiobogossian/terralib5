...
if(GDAL_FOUND)
  ...
  set (TE_USE_WFS TRUE PARENT_SCOPE)
endif()
...
if(WIN32)
	add_definitions(-D_CRT_SECURE_NO_WARNINGS -D_SCL_SECURE_NO_WARNINGS -DTEWFSDLL -DBOOST_ALL_NO_LIB -DBOOST_FILESYSTEM_VERSION=3)
endif(WIN32)
...
exportModuleInformation("wfs" "${SRCDIR}" "wfs")

set (TE_PLUGIN_NAME "te.da.wfs")
set (TE_PLUGIN_DISPLAYNAME "WFS Data Source Driver")
set (TE_PLUGIN_DESCRIPTION "This plugin enables TerraLib to access data via WFS servers")
set (TE_PLUGIN_LIBRARY "terralib_wfs")
set (TE_PLUGIN_HREFDOC "http://www.dpi.inpe.br/terralib5/wiki/doku.php?id=wiki:designimplementation:dataaccess:wfs")
