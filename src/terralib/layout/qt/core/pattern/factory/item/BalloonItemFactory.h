...
/*!
  \file terralib/layout/qt/core/pattern/factory/BalloonItemFactory.h

  \brief This is the concrete factory for balloon item.
 */

#ifndef __TERRALIB_LAYOUT_INTERNAL_BALLOON_ITEM_FACTORY_H
#define __TERRALIB_LAYOUT_INTERNAL_BALLOON_ITEM_FACTORY_H
...
namespace te
{
  namespace layout
  {
    ...
    /*!
      \class BalloonItemFactory

      \brief This is the concrete factory for balloon item.

      \sa NewItemFactory, ParameterizedAbstractFactory, AbstractItemView
    */
    class TELAYOUTEXPORT BalloonItemFactory : public NewItemFactory
    {
      public:
