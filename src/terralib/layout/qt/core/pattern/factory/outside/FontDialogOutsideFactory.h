...
#ifndef __TERRALIB_LAYOUT_INTERNAL_FONT_DIALOG_OUTSIDE_FACTORY_H
#define __TERRALIB_LAYOUT_INTERNAL_FONT_DIALOG_OUTSIDE_FACTORY_H
...
namespace te
{
  namespace layout
  {
    ...
    */
    class TELAYOUTEXPORT FontDialogOutsideFactory : public NewOutsideFactory
    {
      public:

        /*! It register the factory in the abstract dictionary. */
        FontDialogOutsideFactory();
