...
/*!
  \file terralib/ado2/ConnectionPool.h

  \brief A class that implements a connection pool for ADO.  
*/

#ifndef __TERRALIB_ADO_INTERNAL_CONNECTIONPOOL_H
#define __TERRALIB_ADO_INTERNAL_CONNECTIONPOOL_H

// TerraLib
#include "../dataaccess2/datasource/AbstractConnectionPool.h"
#include "Config.h"
...
// Forward declarations
    ...
    /*!
      ...
      \brief This class implements a connection pool for the ADO driver.

      \sa AbstractConnectionPool, ConnectionPoolManager, Connection
    */
    class TEADOEXPORT ConnectionPool : public te::da::AbstractConnectionPool
    {
      public:
        ...
        te::ado::DataSource* getDataSource() const;
...
#endif  // __TERRALIB_ADO_INTERNAL_CONNECTIONPOOL_H
