...
#define TS_TEST_NAME "terralib_unittest_rp_blender"
...
// Printing testResults in XML file
  // The testResult_*.xml files will be saved at TERRALIB_UNITTEST_REPORT_DIR directory.
  ...
  // One level up TERRALIB_UNITTEST_REPORT_DIR should have a 'data' directory with all files used by unit test.
