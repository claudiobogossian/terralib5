...
#ifndef __TERRALIB_GRAPH_INTERNAL_UNDIRECTEDGRAPHFACTORY_H
...
namespace te
{
  namespace graph
  {
    ...
    */
    class TEGRAPHEXPORT UndirectedGraphFactory : public te::graph::AbstractGraphFactory
    {
      public:
      ...
      private:
        ...
        static UndirectedGraphFactory* sm_factory;    //!< Static instance used to register the factory
...
#endif  // __TERRALIB_GRAPH_INTERNAL_UNDIRECTEDGRAPHFACTORY_H
