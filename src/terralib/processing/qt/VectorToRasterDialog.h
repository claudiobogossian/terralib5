...
#ifndef __TERRALIB_PROCESSING_INTERNAL_VECTORTORASTERDIALOG_H
#define __TERRALIB_PROCESSING_INTERNAL_VECTORTORASTERDIALOG_H
...
namespace te
{
  ...
  {
    class TEPROCESSINGEXPORT VectorToRasterDialog : public QDialog
    {
      Q_OBJECT
...
#endif  // __TERRALIB_PROCESSING_INTERNAL_VECTORTORASTERDIALOG_H
