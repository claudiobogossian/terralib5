...
#ifndef __TERRALIB_LAYOUT_INTERNAL_OBJECT_INSPECTOR_OUTSIDE_FACTORY_H
#define __TERRALIB_LAYOUT_INTERNAL_OBJECT_INSPECTOR_OUTSIDE_FACTORY_H
...
namespace te
{
  namespace layout
  {
    ...
    */
    class TELAYOUTEXPORT ObjectInspectorOutsideFactory : public NewOutsideFactory
    {
      public:

        /*! It register the factory in the abstract dictionary. */
        ObjectInspectorOutsideFactory();
