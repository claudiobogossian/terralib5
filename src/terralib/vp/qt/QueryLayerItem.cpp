...
/*!
  \file terralib/vp/qt/QueryLayerItem.cpp
...
te::vp::QueryLayerItem::QueryLayerItem(const te::map::AbstractLayerPtr& l, QObject* parent)
  : AbstractLayerTreeItem(parent)
{
  m_layer = boost::dynamic_pointer_cast<te::map::QueryLayer>(l);
}

te::vp::QueryLayerItem::~QueryLayerItem()
{
}

int te::vp::QueryLayerItem::columnCount() const
{
  return 1;
}

QVariant te::vp::QueryLayerItem::data(int /*column*/, int role) const
{
...
QMenu* te::vp::QueryLayerItem::getMenu(QWidget* /*parent*/) const
{
...
bool te::vp::QueryLayerItem::canFetchMore() const
{
  return false;
}

Qt::ItemFlags te::vp::QueryLayerItem::flags() const
{
  return Qt::ItemIsUserCheckable | Qt::ItemIsDragEnabled | Qt::ItemIsDropEnabled;;
}

void te::vp::QueryLayerItem::fetchMore()
{
}

bool te::vp::QueryLayerItem::hasChildren() const
{
  return false;
}

bool te::vp::QueryLayerItem::setData(const QVariant& value, int role)
{
  if(role == Qt::CheckStateRole)
  {
    bool ok = false;
...
te::map::AbstractLayerPtr te::vp::QueryLayerItem::getLayer() const
{
  return m_layer;
}

//te::vp::AbstractLayerTreeItem* te::vp::QueryLayerItem::clone(QObject* parent)
//{
