...
/*!
  \file terralib/dataaccess/core/datasource/DataTypeCapabilities.h

  \brief A class that represents the supported data types of a specific data source.
*/

#ifndef __TERRALIB_DATAACCESS_CORE_DATASOURCE_INTERNAL_DATATYPECAPABILITIES_H
#define __TERRALIB_DATAACCESS_CORE_DATASOURCE_INTERNAL_DATATYPECAPABILITIES_H
...
#endif  // __TERRALIB_DATAACCESS_CORE_DATASOURCE_INTERNAL_DATATYPECAPABILITIES_H
