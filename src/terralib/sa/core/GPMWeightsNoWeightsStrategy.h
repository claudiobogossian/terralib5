...
/*!
  \file GPMWeightsNoWeightsStrategy.h

  \brief This class defines a class to calculates a weight for a GPM using No Weights strategy.
*/

#ifndef __TERRALIB_SA_INTERNAL_GPMWEIGHTNOWEIGHTSSTRATEGY_H
#define __TERRALIB_SA_INTERNAL_GPMWEIGHTNOWEIGHTSSTRATEGY_H
...
namespace te
{
  namespace sa
  {
    ...
    */
    ...
    class TESAEXPORT GPMWeightsNoWeightsStrategy : public GPMWeightsAbstractStrategy
    {
      public:
...
#endif //__TERRALIB_SA_INTERNAL_GPMWEIGHTNOWEIGHTSSTRATEGY_H