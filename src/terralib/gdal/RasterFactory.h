...
/*!
  \file terralib/gdal/RasterFactory.h

  \brief This is the concrete factory for GDAL rasters.
*/

#ifndef __TERRALIB_GDAL_INTERNAL_RASTERFACTORY_H
#define __TERRALIB_GDAL_INTERNAL_RASTERFACTORY_H
...
namespace te
{
  namespace gdal
  {
    ...
    */
    class TEGDALEXPORT RasterFactory : public te::rst::RasterFactory
    {
      public:
...
#endif  // __TERRALIB_GDAL_INTERNAL_RASTERFACTORY_H
