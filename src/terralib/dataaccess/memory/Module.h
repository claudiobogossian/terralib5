...
/*!
  \file terralib/dataaccess/memory/Module.h
   
  \brief This singleton defines the TerraLib In-Memory module entry.
*/

#ifndef __TERRALIB_DATAACCESS_MEMORY_INTERNAL_MODULE_H
#define __TERRALIB_DATAACCESS_MEMORY_INTERNAL_MODULE_H
      ...
      */
      class Module : public te::common::Singleton<Module>
      {
        ...
        private:
          ...
          /*!
            \brief This is the startup function for the TerraLib In-Memory module.
          ...
          */
          ...
          /*!
            \brief This is the cleanup function for the TerraLib In-Memory module.
...
#endif  // __TERRALIB_DATAACCESS_MEMORY_INTERNAL_MODULE_H
