...
/*!
  \file terralib/qt/plugins/sa/AbstractAction.h

  \brief This file defines the abstract class AbstractAction
*/

#ifndef __TE_QT_PLUGINS_SA_INTERNAL_ABSTRACTACTION_H
#define __TE_QT_PLUGINS_SA_INTERNAL_ABSTRACTACTION_H
    ...
    namespace plugins
    {
      namespace sa
      {
        /*!
          ...
          \brief This is an abstract class used to register actions into sa pluging.
...
#endif //__TE_QT_PLUGINS_SA_INTERNAL_ABSTRACTACTION_H