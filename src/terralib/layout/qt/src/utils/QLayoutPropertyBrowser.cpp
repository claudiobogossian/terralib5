...
/*!
  \file QLayoutPropertyBrowser.cpp
...
te::layout::QLayoutPropertyBrowser::QLayoutPropertyBrowser(QWidget* parent) 
{
  createManager();
}

te::layout::QLayoutPropertyBrowser::~QLayoutPropertyBrowser()
{

}

void te::layout::QLayoutPropertyBrowser::createManager()
{
...
void te::layout::QLayoutPropertyBrowser::propertyEditorValueChanged( QtProperty *property, const QVariant &value )
{
  QList<QtBrowserItem *> list = m_propertyEditor->items(property);
  changePropertyValue(property, list);
}

void te::layout::QLayoutPropertyBrowser::updateExpandState()
{
...
void te::layout::QLayoutPropertyBrowser::clearAll()
{
  updateExpandState();
...
void te::layout::QLayoutPropertyBrowser::addPropertyItem(QtVariantProperty *property, const QString &id)
{
...
void te::layout::QLayoutPropertyBrowser::onChangeFilter( const QString& filter )
{
  QRegExp rx;
...
void te::layout::QLayoutPropertyBrowser::changeVisibility( QList<QtBrowserItem*> items, bool visible )
{
...
QtTreePropertyBrowser* te::layout::QLayoutPropertyBrowser::getPropertyEditor()
{
  return m_propertyEditor;
}

QtVariantPropertyManager* te::layout::QLayoutPropertyBrowser::getVariantPropertyManager()
{
  return m_variantPropertyEditorManager;
}

bool te::layout::QLayoutPropertyBrowser::addProperty( LayoutProperty property )
{
...
bool te::layout::QLayoutPropertyBrowser::removeProperty( LayoutProperty property )
{
  return true;
}

te::layout::LayoutProperty te::layout::QLayoutPropertyBrowser::getProperty( std::string name )
{
  LayoutProperty prop;
  return prop;
}

te::layout::LayoutProperty te::layout::QLayoutPropertyBrowser::getPropertyFromPosition( int pos )
{
  LayoutProperty prop;
  return prop;
}
