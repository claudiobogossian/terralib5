...
#ifndef __TERRALIB_GEOMETRY_INTERNAL_POINTZM_H
#define __TERRALIB_GEOMETRY_INTERNAL_POINTZM_H
...
namespace te
{
  namespace gm
  {
    ...
    */
    class TEGEOMEXPORT PointZM : public Point
    {
      public:
        ...
        */
        ...
        /*!
          ...
          \note The point will take the ownership of the given mbr.
        */
        PointZM(int srid = 0, Envelope* mbr = 0);
...
#endif  // __TERRALIB_GEOMETRY_INTERNAL_POINTZM_H
