...
/*!
  ...
  \brief Configuration flags for the plug-in WMS for application framework.
 */
...
/*!
  \def AF_WMS_TEXT_DOMAIN

  \brief It contains the name of the text domain used in the translation of messages in TerraLib WMS driver implementation.
 */
#define AF_WMS_TEXT_DOMAIN "teaf_wms"

/*!
  \def AF_WMS_TEXT_DOMAIN_DIR

  \brief It contains the translation catalog directory.
 */
#define AF_WMS_TEXT_DOMAIN_DIR "locale"
 ...
 */
#define AF_TR_WMS(message) TR(message, AF_WMS_TEXT_DOMAIN)

/*!
  \def AF_TR_PLURAL_WMS
 ...
 */
#define AF_TR_PLURAL_WMS(message1, message2, n) TR_PLURAL(AF_WMS_TEXT_DOMAIN, message1, message2, n)

/*!
  \def AF_WMS_LOGGER_NAME
  
  \brief This is the fully qualified TerraLib DataAccess API logger name.
 */
#define AF_WMS_LOGGER_NAME "te.af.wms"
...
#endif  // __TERRALIB_AFPLUGINWMS_INTERNAL_CONFIG_H
