        ...
        */
        class GeoPackageBuilderDialog : public QDialog
        {
          ...
          public:
            ...
            std::vector<te::map::AbstractLayerPtr> getGatheringLayers();

            std::vector<te::map::AbstractLayerPtr> getOverlayLayers();

            std::vector<te::map::AbstractLayerPtr> getRasterLayers();			
