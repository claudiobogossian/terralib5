...
#ifndef __TE_QT_PLUGINS_LAYOUT2_INTERNAL_ABSTRACTACTION_H
#define __TE_QT_PLUGINS_LAYOUT2_INTERNAL_ABSTRACTACTION_H
...
#endif //__TE_QT_PLUGINS_LAYOUT2_INTERNAL_ABSTRACTACTION_H