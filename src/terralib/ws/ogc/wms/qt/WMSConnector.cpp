...
te::ws::ogc::wms::qt::WMSConnector::WMSConnector(QWidget *parent, Qt::WindowFlags f)
  : te::qt::widgets::AbstractDataSourceConnector(parent, f)
{
}

te::ws::ogc::wms::qt::WMSConnector::~WMSConnector()
{
}

void te::ws::ogc::wms::qt::WMSConnector::connect(std::list<te::da::DataSourceInfoPtr> &datasources)
{
  std::unique_ptr<WMSConnectorDialog> cdialog(new WMSConnectorDialog(static_cast<QWidget*>(parent())));
...
void te::ws::ogc::wms::qt::WMSConnector::create(std::list<te::da::DataSourceInfoPtr> &datasources)
{
  QMessageBox::information(this,tr("TerraLib Qt Components"), tr("The WMS data access driver not support creation operation."));
}

void te::ws::ogc::wms::qt::WMSConnector::update(std::list<te::da::DataSourceInfoPtr> &datasources)
{
...
void te::ws::ogc::wms::qt::WMSConnector::remove(std::list<te::da::DataSourceInfoPtr> &datasources)
{
  for(std::list<te::da::DataSourceInfoPtr>::iterator it = datasources.begin(); it != datasources.end(); ++it)
  {
    if(it->get() == 0)
