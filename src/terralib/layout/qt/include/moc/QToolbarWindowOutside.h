...
#ifndef __TERRALIB_LAYOUT_INTERNAL_QTOOLBAR_WINDOWOUTSIDE_H 
#define __TERRALIB_LAYOUT_INTERNAL_QTOOLBAR_WINDOWOUTSIDE_H
...
namespace te
{
  namespace layout
  {
    ...
    public:
	    ...
	    QToolbarWindowOutside(LayoutOutsideController* controller, LayoutObservable* o);
