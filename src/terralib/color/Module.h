...
/*!
  \file terralib/color/Module.h
   
  \brief This singleton defines the TerraLib Color module entry.
*/

#ifndef __TERRALIB_COLOR_INTERNAL_MODULE_H
#define __TERRALIB_COLOR_INTERNAL_MODULE_H
    ...
    */
    class Module : public te::common::Singleton<Module>
    {
      ...
      private:
        ...
        /*!
          \brief This is the startup function for the TerraLib Color module.
        ...
        */
        ...
        /*!
          \brief This is the cleanup function for the TerraLib Color module.
...
#endif  // __TERRALIB_COLOR_INTERNAL_MODULE_H
