...
/*!
  \file terralib/dataaccess/memory/TiledBand.h
 
  \brief A tiled band implementation for the In-Memory Raster.
*/

#ifndef __TERRALIB_DATAACCESS_MEMORY_INTERNAL_TILEDBAND_H
#define __TERRALIB_DATAACCESS_MEMORY_INTERNAL_TILEDBAND_H
...
#endif  // __TERRALIB_DATAACCESS_MEMORY_INTERNAL_TILEDBAND_H
