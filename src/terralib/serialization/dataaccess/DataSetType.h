...
namespace te
{
  ...
  namespace serialize
  {
    TESERIALIZATIONEXPORT te::da::DataSetType* ReadDataSetType(te::xml::Reader& reader);

    TESERIALIZATIONEXPORT void Save(const te::da::DataSetType* dt, te::xml::Writer& writer);
