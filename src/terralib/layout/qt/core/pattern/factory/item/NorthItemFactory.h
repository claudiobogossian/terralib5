...
/*!
  \file terralib/layout/qt/core/pattern/factory/NorthItemFactory.h

  \brief This is the concrete factory for north item.
 */

#ifndef __TERRALIB_LAYOUT_INTERNAL_NORTH_ITEM_FACTORY_H
#define __TERRALIB_LAYOUT_INTERNAL_NORTH_ITEM_FACTORY_H
...
namespace te
{
  namespace layout
  {
    ...
    */
    class TELAYOUTEXPORT NorthItemFactory : public NewItemFactory
    {
      public:
