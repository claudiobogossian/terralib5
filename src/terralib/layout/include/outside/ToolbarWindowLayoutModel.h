...
/*!
  \file ToolbarWindowLayoutModel.h
...
#ifndef __TERRALIB_LAYOUT_INTERNAL_TOOLBARWINDOW_LAYOUTMODEL_H 
#define __TERRALIB_LAYOUT_INTERNAL_TOOLBARWINDOW_LAYOUTMODEL_H
