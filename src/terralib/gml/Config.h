...
/*!
  \def TE_GML_TEXT_DOMAIN

  \brief It contains the name of the text domain used in the translation of messages in TerraLib GML module.
 */
#define TE_GML_TEXT_DOMAIN "tegml"

/*!
  \def TE_GML_TEXT_DOMAIN_DIR

  \brief It contains the translation catalog directory.
 */
#define TE_GML_TEXT_DOMAIN_DIR "locale"

/*!
  \def TR_GML

  \brief It marks a string in order to get translated. This is a special mark used in the GML module of TerraLib. 
 */
#define TR_GML(message) TR(message, TE_GML_TEXT_DOMAIN)

/*!
  \def TR_PLURAL_GML

  \brief This mark can be used when you have a plural phrase to be translated. This is a special mark used in the GML module of TerraLib. 
 */
#define TR_PLURAL_GML(message1, message2, n) TR_PLURAL(TE_GML_TEXT_DOMAIN, message1, message2, n)
