...
namespace te
{
  namespace layout
  {
    class LayoutSerialization
    {
      public:
        LayoutSerialization();
        virtual ~LayoutSerialization();

        virtual void loadFromPath(std::string loadPath) = 0;
        virtual void loadFromProperties(std::vector<te::layout::LayoutProperties*> properties) = 0;
        ...
        virtual std::vector<te::layout::LayoutProperties*> retrieve() = 0;
       ...
       protected:
         ...
         std::vector<te::layout::LayoutProperties*> m_properties;
