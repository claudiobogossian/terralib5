...
/*!
  \file terralib/layout/qt/core/pattern/factory/TextItemFactory.h

  \brief This is the concrete factory for text item.
 */

#ifndef __TERRALIB_LAYOUT_INTERNAL_TEXT_ITEM_FACTORY_H
#define __TERRALIB_LAYOUT_INTERNAL_TEXT_ITEM_FACTORY_H
...
namespace te
{
  namespace layout
  {
    ...
    */
    class TELAYOUTEXPORT TextItemFactory : public NewItemFactory
    {
      public:
