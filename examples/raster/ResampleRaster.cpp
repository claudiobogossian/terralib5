...
// set output raster names
    ...
    nnname["URI"] = ""TERRALIB_EXAMPLES_DATA_DIR"/rasters/resampled_nn_scale_plus2.tif";

    std::map<std::string, std::string> biliname;
    biliname["URI"] = ""TERRALIB_EXAMPLES_DATA_DIR"/rasters/resampled_bili_scale_minus2.tif";

    std::map<std::string, std::string> bicname;
    bicname["URI"] = ""TERRALIB_EXAMPLES_DATA_DIR"/rasters/resampled_bic_scale_minus3.tif";
