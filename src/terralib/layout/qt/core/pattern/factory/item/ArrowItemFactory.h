...
/*!
  \file terralib/layout/qt/core/pattern/factory/ArrowItemFactory.h

  \brief This is the concrete factory for arrow item.
 */

#ifndef __TERRALIB_LAYOUT_INTERNAL_ARROW_ITEM_FACTORY_H
#define __TERRALIB_LAYOUT_INTERNAL_ARROW_ITEM_FACTORY_H
...
namespace te
{
  namespace layout
  {
    ...
    */
    class TELAYOUTEXPORT ArrowItemFactory : public NewItemFactory
    {
      public:
