            ...
            class MatchingResult
            {
              public :
                ...
                */                
                ...
                std::vector< te::gm::GTParameters::TiePoint > m_tiePoints; //!< The tie-points generated by matching (first: input raster lines/cols, second:input raster world coords).
