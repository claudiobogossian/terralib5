...
/*!
  \file terralib/common/progress/AbstractProgress.h

  \brief The AbstractProgress is an abstract class used to define the main progress functions.
*/

#ifndef __TERRALIB_COMMON_PROGRESS_INTERNAL_ABSTRACTPROGRESS_H
#define __TERRALIB_COMMON_PROGRESS_INTERNAL_ABSTRACTPROGRESS_H
...
#endif  // __TERRALIB_COMMON_PROGRESS_INTERNAL_ABSTRACTPROGRESS_H
