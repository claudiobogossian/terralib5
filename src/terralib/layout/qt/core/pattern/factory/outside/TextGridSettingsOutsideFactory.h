...
/*!
  \file terralib/layout/qt/core/pattern/factory/outside/TextGridSettingsOutsideFactory.h

  \brief This is the concrete factory for color dialog outside.
 */

#ifndef __TERRALIB_LAYOUT_INTERNAL_TEXT_GRIDSETTINGS_OUTSIDE_FACTORY_H
#define __TERRALIB_LAYOUT_INTERNAL_TEXT_GRIDSETTINGS_OUTSIDE_FACTORY_H
...
namespace te
{
  namespace layout
  {
    ...
    /*!
      \class TextGridSettingsOutsideFactory

      \brief This is the concrete factory for color dialog outside.

      \sa NewOutsideFactory, ParameterizedAbstractFactory, AbstractOutsideView
    */
    class TELAYOUTEXPORT TextGridSettingsOutsideFactory : public NewOutsideFactory
    {
      public:

        /*! It register the factory in the abstract dictionary. */
        TextGridSettingsOutsideFactory();
