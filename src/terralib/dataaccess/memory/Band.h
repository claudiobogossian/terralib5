...
#ifndef __TERRALIB_DATAACCESS_MEMORY_INTERNAL_BAND_H
#define __TERRALIB_DATAACCESS_MEMORY_INTERNAL_BAND_H
...
#endif  // __TERRALIB_DATAACCESS_MEMORY_INTERNAL_BAND_H
