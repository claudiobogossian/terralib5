...
/*!
  \file terralib/wms/Module.h

  \brief The TerraLib WMS driver as a plugin.
*/

#ifndef __TERRALIB_WMS_INTERNAL_MODULE_H
#define __TERRALIB_WMS_INTERNAL_MODULE_H
...
PLUGIN_CALL_BACK_DECLARATION(TEWMSEXPORT);

#endif  // __TERRALIB_WMS_INTERNAL_MODULE_H
