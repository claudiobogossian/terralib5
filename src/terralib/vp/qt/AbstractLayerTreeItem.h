...
/*!
  \file terralib/vp/qt/AbstractLayerTreeItem.h

  \brief A class that represents an item from a LayerTreeModel.
*/

#ifndef __TERRALIB_VP_QT_INTERNAL_ABSTRACTLAYERTREEITEM_H
#define __TERRALIB_VP_QT_INTERNAL_ABSTRACTLAYERTREEITEM_H
...
namespace te
{
  namespace vp
  {
    class TEVPEXPORT AbstractLayerTreeItem : public QObject
    {
      Q_OBJECT
...
#endif  // __TERRALIB_VP_QT_INTERNAL_ABSTRACTLAYERTREEITEM_H
