...
#ifndef __TERRALIB_LAYOUT_INTERNAL_GRIDPLANAR_CONTROLLER_H 
#define __TERRALIB_LAYOUT_INTERNAL_GRIDPLANAR_CONTROLLER_H
  ...
  namespace layout
  {
    ...
    class TELAYOUTEXPORT GridPlanarController : public GridMapController
    {
      public:
        ...
        */
        GridPlanarController( Observable* o );
