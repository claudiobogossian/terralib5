...
void CopyingDataSetToDataSource(te::da::DataSet* dataSet, const std::string& dsName, const std::string& dsInfo)
{
  ...
  //{
  //  std::cout << std::endl << "An exception has occurried in Copying DataSet to DataSource Example: " << e.what() << std::endl;
  //}
  //catch(...)
  //{
  //  std::cout << std::endl << "An unexpected exception has occurried DataSet to DataSource Example!" << std::endl;
  //}
}
