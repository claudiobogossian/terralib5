...
/*!
  \file src/terralib/maptools/serialization/Layer.h
   
  \brief Auxiliary classes and functions to read layer information from a XML document.
*/

#ifndef __TERRALIB_MAPTOOLS_SERIALIZATION_INTERNAL_LAYER_H
#define __TERRALIB_MAPTOOLS_SERIALIZATION_INTERNAL_LAYER_H
...
#endif  // __TERRALIB_MAPTOOLS_SERIALIZATION_INTERNAL_LAYER_H
