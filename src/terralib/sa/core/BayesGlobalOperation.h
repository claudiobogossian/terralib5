...
/*!
  \file terralib/sa/core/BayesGlobalOperation.h
...
#ifndef __TERRALIB_SA_INTERNAL_BAYESGLOBALOPERATION_H
#define __TERRALIB_SA_INTERNAL_BAYESGLOBALOPERATION_H
...
namespace te
{
  ...
  namespace sa
  {
    ...
    */
    class TESAEXPORT BayesGlobalOperation
    {
      public:
...
#endif //__TERRALIB_SA_INTERNAL_BAYESGLOBALOPERATION_H