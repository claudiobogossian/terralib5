...
te::qt::plugins::layout2::AbstractAction::AbstractAction(QMenu* menu): m_menu(menu), m_action(0)
{
}

te::qt::plugins::layout2::AbstractAction::~AbstractAction()
{
}

void te::qt::plugins::layout2::AbstractAction::createAction(std::string name, std::string pixmap)
{
  assert(m_menu);
