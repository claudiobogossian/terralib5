...
#ifndef __TERRALIB_EDIT_QT_INTERNAL_VERTEX_COMMAND_H 
#define __TERRALIB_EDIT_QT_INTERNAL_VERTEX_COMMAND_H
...
namespace te
{
  namespace edit
  {
    ...
    */
    class TEEDITQTEXPORT VertexCommand : public QUndoCommand
    {
    public:
      // Pass all parameters that the command need to fulfill its task in the constructor
      VertexCommand(std::vector<Feature*> items, te::qt::widgets::MapDisplay* display, const te::map::AbstractLayerPtr& layer, QUndoCommand *parent = 0);
