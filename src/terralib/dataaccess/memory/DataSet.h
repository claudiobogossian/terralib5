...
/*!
  \file terralib/dataaccess/memory/DataSet.h

  \brief Implementation of a random-access dataset class for the TerraLib In-Memory Data Access driver.
*/

#ifndef __TERRALIB_DATAACCESS_MEMORY_INTERNAL_DATASET_H
#define __TERRALIB_DATAACCESS_MEMORY_INTERNAL_DATASET_H
...
// Forward declarations
      ...
      /*!
        ...
        \sa te::da::core::DataSet
      */
      class TEMEMORYEXPORT DataSet : public te::da::core::DataSet
      {
        public:
          ...
          */
          explicit DataSet(const te::da::core::DataSetType* const dt);
          ...
          */
          DataSet(te::da::core::DataSet& rhs);
          ...
          */
          DataSet(te::da::core::DataSet& rhs, const std::vector<std::size_t>& properties, std::size_t limit = 0);
          ...
          */
          void copy(te::da::core::DataSet& src, std::size_t limit = 0);
          ...
          /*!
            ...
            \note In-Memory driver extended method.
          */
          void copy(te::da::core::DataSet& src, const std::vector<std::size_t>& properties, std::size_t limit = 0);
...
#endif  // __TERRALIB_DATAACCESS_MEMORY_INTERNAL_DATASET_H
