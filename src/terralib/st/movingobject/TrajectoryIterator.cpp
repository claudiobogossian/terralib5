...
te::st::TrajectoryIterator::TrajectoryIterator(MovingObjectIterator it) :
  m_it(it)
{
}
...
te::gm::Geometry* te::st::TrajectoryIterator::getGeometry()
{
  return m_it.getGeometry();
}

te::dt::DateTime* te::st::TrajectoryIterator::getDateTime()
{
