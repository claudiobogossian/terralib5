...
#ifndef __TERRALIB_UNITTEST_COMMON_INTERNAL_DATETIME_H
#define __TERRALIB_UNITTEST_COMMON_INTERNAL_DATETIME_H
...
#endif  // __TERRALIB_UNITTEST_COMMON_INTERNAL_DATETIME_H
