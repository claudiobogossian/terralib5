...
#ifndef __TERRALIB_QT_WIDGETS_INTERNAL_GEOGRAPHIC_GRID_FRAME_H
#define __TERRALIB_QT_WIDGETS_INTERNAL_GEOGRAPHIC_GRID_FRAME_H
...
namespace te
{
  namespace qt
  {
    namespace widgets
    {
      class DataFrame;
      /*!
        \class GographicGridFrame

        \brief A GographicGridFrame ....

      */
      class TEQTWIDGETSEXPORT GeographicGridFrame : public GridFrame
      {
        public:
...
#endif  // __TERRALIB_QT_WIDGETS_INTERNAL_GEOGRAPHIC_GRID_FRAME_H
