...
#ifndef __TERRALIB_QT_AF_EVENTS_INTERNAL_LAYERADDED_H
#define __TERRALIB_QT_AF_EVENTS_INTERNAL_LAYERADDED_H
...
namespace te
{
  ...
  namespace qt
  {
    namespace af
    {
      /*!
        \class LayerAdded
        \copydoc LayerAdded.h
        \ingroup afevents
      */
      class LayerAdded : public Event
      {
        public:
          ...
          */
          ...
          Event(te::qt::af::evt::LAYER_ADDED),
          m_layer(newlayer)
          {
          }
...
#endif  // __TERRALIB_QT_AF_EVENTS_INTERNAL_LAYERADDED_H
