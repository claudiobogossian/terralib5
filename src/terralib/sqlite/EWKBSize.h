...
namespace te
{
  namespace sqlite
  {
    /*!
      ...
      \sa EWKBWriter
    */
    class TESQLITEEXPORT EWKBSize : public te::gm::Visitor
    {
      public:
        ...
        /*!
          \brief It calculates the size in bytes needed to store the given geometry in a SpatiaLite geometry column.

          \param g The geometry to get the SQLite ewkb size.

          \return The size in bytes needed to store the given geometry.
        */
