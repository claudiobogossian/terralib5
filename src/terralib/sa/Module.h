...
#ifndef __TERRALIB_SA_CORE_INTERNAL_MODULE_H
#define __TERRALIB_SA_CORE_INTERNAL_MODULE_H
  ...
  namespace sa
  {
    ...
    */
    class Module : public te::common::Singleton<Module>
    {
      ...
      /*!
        \brief This is the startup function for the TerraLib Spatial Analysis module.
      ...
      */
      ...
      /*!
        \brief This is the cleanup function for the TerraLib Spatial Analysis module.
...
#endif  // __TERRALIB_SA_CORE_INTERNAL_MODULE_H
