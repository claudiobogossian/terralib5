...
/*!
  \file terralib/layout/qt/core/pattern/factory/BarCodeItemFactory.h

  \brief This is the concrete factory for bar code item.
 */

#ifndef __TERRALIB_LAYOUT_INTERNAL_BAR_CODE_ITEM_FACTORY_H
#define __TERRALIB_LAYOUT_INTERNAL_BAR_CODE_ITEM_FACTORY_H
...
namespace te
{
  namespace layout
  {
    ...
    /*!
      \class BarCodeItemFactory

      \brief This is the concrete factory for bar code item.

      \sa NewItemFactory, ParameterizedAbstractFactory, AbstractItemView
    */
    class TELAYOUTEXPORT BarCodeItemFactory : public NewItemFactory
    {
      public:
